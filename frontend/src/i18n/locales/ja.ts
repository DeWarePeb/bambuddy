export default {
  ...
  printers: {
    ...
    tv: {
      title: 'プリントファーム',
      backToApp: 'Bambuddy に戻る',
      tokenRejected: 'このTVリンクは無効です。トークンの期限が切れたか、取り消されています。',
      refreshInterval: '更新',
    ...
    toast: {
      ...
      historyImported_one: '{{count}} 件の印刷を取り込みました',
      historyImported_other: '{{count}} 件の印刷を取り込みました',
      historyNothingNew: '取り込む新しい印刷はありません',
      historyImportFailed: '印刷履歴を取り込めませんでした',
    ...
    modal: {
      ...
      chamberObject: 'チャンバーセンサー',
      chamberObjectAuto: '自動',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: 'チャンバーの温度を報告する Klipper オブジェクトです。自動では chamber という名前のものを探します。別の名前の場合は選んでください。',
      chamberObjectUsing: '自動で {{name}} を検出しました。',
      transport: 'ステータス更新',
      transportAuto: 'プッシュ（ポーリングを併用）',
      transportPoll: 'ポーリングのみ',
      transportHelp: 'プッシュ更新は Moonraker の WebSocket 経由で届き、1 秒足らずでカードに反映されます。どちらの場合もポーリングは続きます。Bambuddy とプリンタの間に WebSocket 接続を通さない機器がある場合のみ、ポーリングのみを選んでください。',
      moonrakerApiKeyHelp: 'このホストで Moonraker が認証を要求する場合のみ必要です。',
      klipperModelPlaceholder: '例: Voron 2.4 350',
      importHistory: '印刷履歴',
      importHistoryButton: 'Moonraker から取り込む',
      importHistoryHelp: 'Moonraker が記録しているすべてのジョブを、ファイルなしでアーカイブに追加します。取り込み済みのジョブはスキップされるため、何度実行しても安全です。',
      saveChanges: '変更を保存',
    },
    // Skip objects
    skipObjects: {
    ...
    discovery: {
      ...
      scanKlipper: 'ネットワークからKlipperプリンタを検索',
  ...
  archives: {
    ...
    card: {
      ...
      layer: '{{count}} レイヤー',
      layers: '{{count}} レイヤー',
      priceTitle: '提案価格。コスト {{cost}}、粗利率 {{margin}}。',
      priceFloor: '下限',
      object: '{{count}}オブジェクト',
  ...
  settings: {
    ...
    openFilamentDatabase: 'Open Filament Database でスプールを検索',
    openFilamentDatabaseDesc: 'スプール追加フォームに検索機能を追加し、openfilamentdatabase.org からブランド・素材・色・重量・温度を自動入力します。使用時、Bambuddy はバックエンドからそのサイトにアクセスします。',
    ...
    pricingEnabled: '販売価格の目安',
    pricingEnabledDescription: 'アーカイブした印刷を、フィラメント代と電気代からいくらで売るべきか表示します。印刷をコストセンターに請求する課金機能とは別のものです。',
    pricingLabourPerHour: '印刷1時間あたりの工賃',
    pricingMarkup: '掛け率',
    pricingFloor: '最低価格',
    pricingReference: '直近 {{days}} 日間の {{samples}} 件の印刷から、一般的な印刷の製造コストは {{cost}} です。',
    pricingReferenceEmpty: '費用の記録された印刷がまだないため、掛け率を照らし合わせる標準的なコストがありません。',
  ...
  farm: {
    title: 'ファーム コマンドセンター',
    subtitle: 'プリント運用のリアルタイム概要',
    utilization: '稼働率',
    tvMode: 'TVモード',
    fleetStatus: 'プリンター状況',
    searchPrinters: 'プリンターを検索...',
    groupFilter: 'グループで絞り込む',
    allGroups: 'すべてのグループ',
    createGroup: 'グループを作成',
    ungrouped: 'グループなし',
    noPrintersMatch: '条件に一致するプリンターがありません。',
    activeProjects: '進行中のプロジェクト',
    viewAllProjects: 'すべてのプロジェクト',
    noActiveProjects: '現在追跡中のプロジェクトはありません。',
    totalCount: '合計 {{count}} 台',
    onlineCount: 'オンライン {{count}} 台',
    offlineCount: 'オフライン {{count}} 台',
    allOperational: 'すべて正常',
    needAttention_one: '{{count}} 件が対応待ちです',
    needAttention_other: '{{count}} 件が対応待ちです',
    noIssues: '問題はありません',
    openAlerts: 'アラート一覧を開く',
    filamentStock: 'フィラメント在庫',
    spoolsLow_one: 'スプール {{count}} 個が残りわずか',
    spoolsLow_other: 'スプール {{count}} 個が残りわずか',
    maintenance: 'メンテナンス',
    maintenanceDue_one: 'メンテナンス {{count}} 件が対応待ちです',
    maintenanceDue_other: 'メンテナンス {{count}} 件が対応待ちです',
    state: {
      printing: '印刷中',
      paused: '一時停止',
      idle: '待機中',
    ...
    stats: {
      ...
      partsToday: '本日の部品',
      ofFleet: '全体の {{percent}}%',
      alertsSub: 'プリンター、在庫、メンテナンス',
      queueTracked_one: 'キューに {{count}} 件',
      queueTracked_other: 'キューに {{count}} 件',
    },
    project: {
      queued: 'キュー {{count}} 件',
      failed: '失敗 {{count}} 件',
    ...
    alerts: {
      title: 'アラート',
      subtitle: '対応が必要なプリンター、フィラメント、メンテナンス。',
      empty: '現在対応が必要な項目はありません。',
      printerError: 'プリンターがエラーを報告しています',
      printerPaused: '一時停止中 - 対応が必要な場合があります',
      printerOffline: 'オフラインまたは接続できません',
      spoolLow: 'フィラメント残り {{percent}}%',
      maintenance: '{{item}}',
    },
    groups: {
      title: 'プリンターグループ',
      subtitle: 'コマンドセンターでまとめるためにプリンターをグループ化します。',
      nameLabel: 'グループ名',
      current: '現在のグループ',
      printerCount_one: 'プリンター {{count}} 台',
      printerCount_other: 'プリンター {{count}} 台',
      save: 'グループを保存',
    },
  },
  projects: {
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: 'ブランド・素材・フィラメント・色を選ぶと、このスプールの項目が自動入力されます。すべての項目は後から編集できます。',
      brandLabel: 'ブランド',
      brandPlaceholder: 'OFDBのブランドを検索...',
      brandLoadFailed: 'Open Filament Database からブランドを読み込めませんでした',
      noBrands: 'Open Filament Database にブランドが見つかりません。',
      materialLabel: '素材',
      materialLoadFailed: 'このブランドの素材を読み込めませんでした',
      noMaterials: 'このブランドには素材が登録されていません。',
      filamentLabel: 'フィラメント',
      filamentPlaceholder: 'フィラメントを絞り込む...',
      searchFailed: 'このブランドと素材のフィラメントを読み込めませんでした',
      noFilaments: 'このブランドと素材に該当するフィラメントはありません。',
      filamentLoadFailed: 'フィラメントの詳細を読み込めませんでした',
      noVariants: 'このフィラメントには色が登録されていません。',
      variantLabel: '色',
      variantLoadFailed: '色の詳細を読み込めませんでした',
      applied: 'Open Filament Database から自動入力しました。保存する前に内容を確認してください。',
      materialCount: '{{count}} 件の素材',
      filamentCount: '{{count}} 件のフィラメント',
      variantCount: '{{count}} 色',
    ...
    nextSlot: {
      action: '次に読み込まれるAMSスロットに割り当てる',
      badge: '{{printer}} の次のスロット',
      badgeTitle: '次に読み込まれるAMSスロットを待っています。{{expires}} に期限切れになります。',
      anyPrinter: '任意のプリンタ',
      cancel: '次スロットへの割り当てをキャンセル',
      cancelled: '次スロットへの割り当てをキャンセルしました',
      cancelError: '次スロットへの割り当てをキャンセルできませんでした',
      modalTitle: '次に読み込まれるスロットに割り当てる',
      modalIntro: '下のプリンタの空いているAMSスロットに {{spool}} を装填してください。プリンタが認識した時点で、そのスロットがこのスプールに割り当てられ、フィラメント設定も反映されます。',
      printerLabel: 'プリンタ',
      timeoutLabel: '最大待機時間',
      timeoutOptions: {
        m15: '15分',
      ...
      rfidNote: 'RFIDタグがすでに在庫内の別のスプールに紐づいている Bambu Lab のスプールは、その登録を保持します。この要求はそのまま次のスロットを待ちます。',
      submit: '次のスロットを待つ',
      submitting: '保存中...',
      created: '{{printer}} で次に読み込まれるスロットを待っています',
      createError: '次スロットへの割り当てを作成できませんでした',
      completedToast: 'スプールを {{printer}} {{slot}} に割り当てました',
      timedOutToast: 'スプールが装填されないまま、次スロットへの割り当てが期限切れになりました',
      fromSlotDialog: '代わりに次に読み込まれるスロット',
    },
  ...
  printModal: {
    ...
    jobName: 'ジョブ名',
    jobNamePlaceholder: '例: 注文 1234',
    jobNameHint: 'プリンタに送るファイルの名前になります。プリンタの画面にモデル名ではなくこの名前が表示されます。',
  ...
  smartPlugs: {
    ...
    moonrakerDevice: '電源デバイス',
    moonrakerDeviceHelp: 'プリンター自身の Moonraker にある [power] デバイスです。アドレスと API キーはプリンターから取得するため、そちらを変更してもこのプラグは動き続けます。',
    moonrakerPickPrinter: '先に下で Klipper プリンターを選択してください。',
    moonrakerSelectDevice: 'デバイスを選択…',
    moonrakerNoDevices: 'このプリンターの Moonraker に [power] デバイスが設定されていません。',
    moonrakerDevicesFailed: 'Moonraker から電源デバイスを取得できませんでした。',
    moonrakerPrinterRequired: 'この電源デバイスに Klipper プリンターを選択してください',
    moonrakerDeviceRequired: '電源デバイスを選択してください',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: 'Notify アプリによる iOS プッシュ通知。Dynamic Island に印刷進捗のライブタイルを表示します',
    },
    ...
    printAlmostDone: 'まもなく完了',
    printAlmostDoneDescription: '97% でカメラ画像付きの通知を送り、印刷が終わった瞬間に部品を取り外せるようにします',
    printerOffline: 'プリンターオフライン',
    printerError: 'プリンターエラー',
    ...
    printAlmostDoneHint: '(97%、カメラ画像付き)',
  ...
  cameraTokens: {
    ...
    create: {
      ...
      hintTv:
        'TV トークンはログインなしの画面で /tv を開きます（壁掛けディスプレイ、キオスクモードの Pi など）。各プリンターの状態、印刷中のファイル、進捗、装填中のスプール、そしてカメラのスナップショットを見ることができます。アドレスやアクセスコードは見えません。',
      title: '新しいトークンを作成',
      nameLabel: 'トークン名',
    ...
    created: {
      ...
      tvUrlTitle: 'この画面用の TV URL',
      tvUrlHint:
        'この URL を画面で開いてください。&cams=0 でカメラ映像を非表示に、&refresh=10 で更新間隔を変更できます。URL を読める人は誰でもこの画面を見られるため、鍵と同じように扱い、止めたいときはトークンを失効させてください。',
