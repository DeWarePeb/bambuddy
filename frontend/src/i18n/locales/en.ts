export default {
  ...
  printers: {
    ...
    toast: {
      ...
      historyImported_one: '{{count}} print imported',
      historyImported_other: '{{count}} prints imported',
      historyNothingNew: 'No new prints to import',
      historyImportFailed: 'Could not import the print history',
    ...
    modal: {
      ...
      providerLabel: 'Printer type',
      providerBambu: 'Bambu Lab',
      providerKlipper: 'Klipper (Moonraker)',
      moonrakerUrl: 'Moonraker URL',
      moonrakerUrlHelp: 'The address of Mainsail or Fluidd, e.g. http://voron.local or http://192.168.1.50. Serial number and IP are derived from it.',
      moonrakerApiKey: 'Moonraker API key (optional)',
      chamberObject: 'Chamber sensor',
      chamberObjectAuto: 'Automatic',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: 'Which Klipper object reports the chamber. Automatic looks for one named chamber; pick yours if it is called something else.',
      chamberObjectUsing: 'Automatic found {{name}}.',
      transport: 'Status updates',
      transportAuto: 'Pushed, with polling as backup',
      transportPoll: 'Polling only',
      transportHelp: "Pushed updates come over Moonraker's WebSocket and reach the card in well under a second. Polling continues either way, so choose polling only if something between Bambuddy and the printer refuses WebSocket connections.",
      moonrakerApiKeyHelp: 'Only needed when Moonraker requires authentication for this host.',
      klipperModelPlaceholder: 'e.g. Voron 2.4 350',
      importHistory: 'Print history',
      importHistoryButton: 'Import from Moonraker',
      importHistoryHelp: 'Adds every job Moonraker remembers to the archive, without files. Already-imported jobs are skipped, so this is safe to run again.',
    ...
    firmwareSystemPackages_one: 'system: {{count}} package update',
    firmwareSystemPackages_other: 'system: {{count}} package updates',
  ...
  archives: {
    ...
    card: {
      ...
      layer: '{{count}} layer',
      layers: '{{count}} layers',
      priceTitle: 'Suggested price. Cost {{cost}}, margin {{margin}}.',
      priceFloor: 'floor',
      object: '{{count}} object',
  ...
  settings: {
    ...
    openFilamentDatabase: 'Search spools via Open Filament Database',
    openFilamentDatabaseDesc: 'Adds a lookup to the Add Spool form that prefills brand, material, colour, weight and temperatures from openfilamentdatabase.org. Bambuddy calls that site from the backend when you use it.',
    ...
    pricingEnabled: 'Suggested selling price',
    pricingEnabledDescription: 'Show what an archived print should sell for, from its filament and energy cost. Separate from billing, which charges printing to a cost centre.',
    pricingLabourPerHour: 'Labour per print hour',
    pricingMarkup: 'Markup',
    pricingFloor: 'Minimum price',
    pricingReference: 'A typical print of yours costs {{cost}} to make, over {{samples}} prints in the last {{days}} days.',
    pricingReferenceEmpty: 'No priced prints yet, so there is no typical cost to hold a markup against.',
  ...
  farm: {
    ...
    subtitle: 'Real-time overview of your printing operation',
    ...
    createGroup: 'Create group',
    ungrouped: 'Ungrouped',
    noPrintersMatch: 'No printers match the current filters.',
    activeProjects: 'Active projects',
    viewAllProjects: 'View all projects',
    noActiveProjects: 'No active projects are currently tracked.',
    totalCount: '{{count}} total',
    onlineCount: '{{count}} online',
    offlineCount: '{{count}} offline',
    allOperational: 'All systems operational',
    needAttention_one: '{{count}} item needs attention',
    needAttention_other: '{{count}} items need attention',
    noIssues: 'No active issues',
    openAlerts: 'Open the alert list',
    filamentStock: 'Filament stock',
    spoolsLow_one: '{{count}} spool low in stock',
    spoolsLow_other: '{{count}} spools low in stock',
    maintenance: 'Maintenance',
    maintenanceDue_one: '{{count}} maintenance item needs attention',
    maintenanceDue_other: '{{count}} maintenance items need attention',
    state: {
      printing: 'Printing',
      paused: 'Paused',
      idle: 'Idle',
    ...
    stats: {
      ...
      paused: 'Paused',
      alerts: 'Alerts',
      partsToday: 'Parts today',
      ofFleet: '{{percent}}% of fleet',
      alertsSub: 'Printers, stock, maintenance',
      queueTracked_one: '{{count}} queue item tracked',
      queueTracked_other: '{{count}} queue items tracked',
    },
    project: {
      queued: '{{count}} queued',
      failed: '{{count}} failed',
    ...
    alerts: {
      ...
      subtitle: 'Printer, filament and maintenance items that need attention.',
      empty: 'Nothing needs attention right now.',
      printerError: 'Printer reported an error',
      printerPaused: 'Paused - may need a hand',
      printerOffline: 'Offline or unreachable',
      spoolLow: '{{percent}}% filament remaining',
      maintenance: '{{item}}',
    },
    groups: {
      title: 'Printer groups',
      subtitle: 'Group printers to bucket them on the command center.',
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: 'Pick a brand, material, filament and colour to prefill this spool. Every field stays editable.',
      brandLabel: 'Brand',
      brandPlaceholder: 'Search OFDB brands...',
      brandLoadFailed: 'Could not load brands from Open Filament Database',
      noBrands: 'No brands found in Open Filament Database.',
      materialLabel: 'Material',
      materialLoadFailed: 'Could not load the materials for this brand',
      noMaterials: 'This brand has no materials listed.',
      filamentLabel: 'Filament',
      filamentPlaceholder: 'Filter filaments...',
      searchFailed: 'Could not load the filaments for this brand and material',
      noFilaments: 'No filaments listed for this brand and material.',
      filamentLoadFailed: 'Could not load the filament details',
      noVariants: 'This filament has no colours listed.',
      variantLabel: 'Colour',
      variantLoadFailed: 'Could not load the colour details',
      applied: 'Prefilled from Open Filament Database. Check the fields before saving.',
      materialCount: '{{count}} material(s)',
      filamentCount: '{{count}} filament(s)',
      variantCount: '{{count}} colour(s)',
    ...
    nextSlot: {
      action: 'Assign to the next loaded AMS slot',
      badge: 'Next slot on {{printer}}',
      badgeTitle: 'Waiting for the next loaded AMS slot. Expires at {{expires}}.',
      anyPrinter: 'any printer',
      cancel: 'Cancel next-slot assignment',
      cancelled: 'Next-slot assignment cancelled',
      cancelError: 'Could not cancel the next-slot assignment',
      modalTitle: 'Assign to the next loaded slot',
      modalIntro: 'Load {{spool}} into a free AMS slot on the printer below. The moment the printer reports it, the slot is assigned to this spool, filament settings included.',
      printerLabel: 'Printer',
      timeoutLabel: 'Wait at most',
      timeoutOptions: {
        m15: '15 minutes',
        m30: '30 minutes',
        h2: '2 hours',
      ...
      rfidNote: 'A Bambu Lab spool whose RFID tag already belongs to another inventory spool keeps that entry; this request then waits for the next slot.',
      submit: 'Wait for next slot',
      submitting: 'Saving...',
      created: 'Waiting for the next loaded slot on {{printer}}',
      createError: 'Could not create the next-slot assignment',
      completedToast: 'Spool assigned to {{printer}} {{slot}}',
      timedOutToast: 'A next-slot assignment expired before a spool was loaded',
      fromSlotDialog: 'Next loaded slot instead',
    },
  ...
  printModal: {
    ...
    jobName: 'Job name',
    jobNamePlaceholder: 'e.g. Order 1234',
    jobNameHint: 'Names the file sent to the printer, so its screen shows this instead of the model name.',
  ...
  smartPlugs: {
    ...
    moonrakerDevice: 'Power device',
    moonrakerDeviceHelp: "A [power] device from the printer's own Moonraker. The address and API key come from the printer, so editing those keeps this plug working.",
    moonrakerPickPrinter: 'Select a Klipper printer below first.',
    moonrakerSelectDevice: 'Select a device…',
    moonrakerNoDevices: "This printer's Moonraker has no [power] devices configured.",
    moonrakerDevicesFailed: 'Could not read the power devices from Moonraker.',
    moonrakerPrinterRequired: 'Select a Klipper printer for this power device',
    moonrakerDeviceRequired: 'Select a power device',
