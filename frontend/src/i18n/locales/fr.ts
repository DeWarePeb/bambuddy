export default {
  ...
  alerts: {
    ...
    spoolLowOn: '{{spool}} ({{percent}} %, dans {{printer}})',
  ...
  printers: {
    ...
    tv: {
      title: 'Parc d\'impression',
      backToApp: 'Retour à Bambuddy',
      tokenRejected: 'Ce lien TV n\'est plus valide. Le jeton a expiré ou a été révoqué.',
      refreshInterval: 'Actualisation',
      everySeconds: 'toutes les {{seconds}}s',
      cameras: 'Caméras',
      total: '{{count}} imprimantes',
      currentJob: 'Tâche en cours',
      unnamedJob: 'Impression en cours',
      progress: 'Progression de l\'impression',
      eta: 'Fin {{time}}',
      idleHint: {
        idle: 'Prête à imprimer',
        finished: 'Impression terminée, plateau pas encore dégagé',
        error: 'Demande une intervention',
    ...
    toast: {
      ...
      historyImported_one: '{{count}} impression importée',
      historyImported_other: '{{count}} impressions importées',
      historyNothingNew: 'Aucune nouvelle impression à importer',
      historyImportFailed: "Impossible d'importer l'historique des impressions",
    ...
    modal: {
      ...
      providerLabel: 'Type d’imprimante',
      providerBambu: 'Bambu Lab',
      providerKlipper: 'Klipper (Moonraker)',
      moonrakerUrl: 'URL Moonraker',
      moonrakerUrlHelp: 'L’adresse de Mainsail ou Fluidd, p. ex. http://voron.local ou http://192.168.1.50. Le numéro de série et l’IP en sont déduits.',
      moonrakerApiKey: 'Clé API Moonraker (facultatif)',
      chamberObject: 'Capteur du caisson',
      chamberObjectAuto: 'Automatique',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: "Quel objet Klipper renseigne le caisson. Le mode automatique cherche un objet nommé chamber ; choisissez le vôtre s'il porte un autre nom.",
      chamberObjectUsing: 'Le mode automatique a trouvé {{name}}.',
      transport: "Mises à jour d'état",
      transportAuto: 'Push, avec interrogation en secours',
      transportPoll: 'Interrogation seule',
      transportHelp: "Les mises à jour push passent par le WebSocket de Moonraker et atteignent la carte en bien moins d'une seconde. L'interrogation continue de toute façon ; ne choisissez l'interrogation seule que si quelque chose entre Bambuddy et l'imprimante refuse les connexions WebSocket.",
      moonrakerApiKeyHelp: 'Nécessaire uniquement si Moonraker exige une authentification pour cet hôte.',
      klipperModelPlaceholder: 'p. ex. Voron 2.4 350',
      importHistory: 'Historique des impressions',
      importHistoryButton: 'Importer depuis Moonraker',
      importHistoryHelp: "Ajoute à l'archive chaque impression que Moonraker a mémorisée, sans les fichiers. Les impressions déjà importées sont ignorées : vous pouvez relancer sans risque.",
    ...
    discovery: {
      ...
      scanKlipper: 'Rechercher des imprimantes Klipper sur le réseau',
    ...
    firmwareSystemPackages_one: 'système : {{count}} mise à jour de paquet',
    firmwareSystemPackages_other: 'système : {{count}} mises à jour de paquets',
  ...
  archives: {
    ...
    card: {
      ...
      priceTitle: 'Prix suggéré. Coût {{cost}}, marge {{margin}}.',
      priceFloor: 'minimum',
      object: '{{count}} objet',
  ...
  settings: {
    ...
    openFilamentDatabase: 'Rechercher des bobines via Open Filament Database',
    openFilamentDatabaseDesc: "Ajoute au formulaire d'ajout de bobine une recherche qui préremplit la marque, le matériau, la couleur, le poids et les températures depuis openfilamentdatabase.org. Bambuddy interroge ce site depuis le backend lorsque vous l'utilisez.",
    ...
    pricingEnabled: 'Prix de vente suggéré',
    pricingEnabledDescription: "Affiche à combien une impression archivée devrait se vendre, à partir de son coût de filament et d'énergie. Distinct de la facturation, qui impute les impressions à un centre de coûts.",
    pricingLabourPerHour: "Main-d'œuvre par heure d'impression",
    pricingMarkup: 'Coefficient',
    pricingFloor: 'Prix minimum',
    pricingReference: 'Une impression typique vous coûte {{cost}} à produire, sur {{samples}} impressions des {{days}} derniers jours.',
    pricingReferenceEmpty: "Aucune impression chiffrée pour l'instant, donc pas de coût typique auquel confronter un coefficient.",
  ...
  printerFiles: {
    printOnPrinter: 'Lancer sur l’imprimante',
    printStarted: 'Impression lancée sur l’imprimante',
    printFailed: 'Impossible de lancer l’impression : {{error}}',
  ...
  farm: {
    ...
    subtitle: 'Vue d\'ensemble en temps réel de votre atelier',
    utilization: 'Utilisation',
    tvMode: 'Mode TV',
    fleetStatus: 'État du parc',
    searchPrinters: 'Rechercher des imprimantes...',
    groupFilter: 'Filtrer par groupe',
    allGroups: 'Tous les groupes',
    createGroup: 'Créer un groupe',
    ungrouped: 'Sans groupe',
    noPrintersMatch: 'Aucune imprimante ne correspond aux filtres.',
    activeProjects: 'Projets actifs',
    viewAllProjects: 'Tous les projets',
    noActiveProjects: 'Aucun projet actif n\'est suivi actuellement.',
    totalCount: '{{count}} au total',
    onlineCount: '{{count}} en ligne',
    offlineCount: '{{count}} hors ligne',
    allOperational: 'Tout fonctionne',
    needAttention_one: '{{count}} élément demande votre attention',
    needAttention_other: '{{count}} éléments demandent votre attention',
    noIssues: 'Aucun problème en cours',
    openAlerts: 'Ouvrir la liste des alertes',
    filamentStock: 'Stock de filament',
    spoolsLow_one: '{{count}} bobine presque vide',
    spoolsLow_other: '{{count}} bobines presque vides',
    maintenance: 'Maintenance',
    maintenanceDue_one: '{{count}} entretien demande votre attention',
    maintenanceDue_other: '{{count}} entretiens demandent votre attention',
    state: {
      printing: 'Impression',
      paused: 'En pause',
      idle: 'Inactive',
    ...
    stats: {
      ...
      paused: 'En pause',
      alerts: 'Alertes',
      partsToday: 'Pièces aujourd\'hui',
      ofFleet: '{{percent}}% du parc',
      alertsSub: 'Imprimantes, stock, maintenance',
      queueTracked_one: '{{count}} élément dans la file',
      queueTracked_other: '{{count}} éléments dans la file',
    },
    project: {
    ...
    alerts: {
      title: 'Alertes',
      subtitle: 'Imprimantes, filament et maintenance qui demandent votre attention.',
      empty: 'Rien ne demande votre attention pour l\'instant.',
      printerError: 'L\'imprimante signale une erreur',
      printerPaused: 'En pause - une intervention est peut-être nécessaire',
      printerOffline: 'Hors ligne ou injoignable',
      spoolLow: '{{percent}}% de filament restant',
      maintenance: '{{item}}',
    },
    groups: {
      title: 'Groupes d\'imprimantes',
      subtitle: 'Regroupez les imprimantes pour les organiser dans le centre de commande.',
      nameLabel: 'Nom du groupe',
      current: 'Groupes actuels',
      printerCount_one: '{{count}} imprimante',
      printerCount_other: '{{count}} imprimantes',
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: 'Choisissez une marque, un matériau, un filament et une couleur pour préremplir cette bobine. Tous les champs restent modifiables.',
      brandLabel: 'Marque',
      brandPlaceholder: 'Rechercher des marques OFDB...',
      brandLoadFailed: 'Impossible de charger les marques depuis Open Filament Database',
      noBrands: 'Aucune marque trouvée dans Open Filament Database.',
      materialLabel: 'Matériau',
      materialLoadFailed: 'Impossible de charger les matériaux de cette marque',
      noMaterials: 'Aucun matériau listé pour cette marque.',
      filamentLabel: 'Filament',
      filamentPlaceholder: 'Filtrer les filaments...',
      searchFailed: 'Impossible de charger les filaments pour cette marque et ce matériau',
      noFilaments: 'Aucun filament listé pour cette marque et ce matériau.',
      filamentLoadFailed: 'Impossible de charger les détails du filament',
      noVariants: 'Aucune couleur listée pour ce filament.',
      variantLabel: 'Couleur',
      variantLoadFailed: 'Impossible de charger les détails de la couleur',
      applied: "Prérempli depuis Open Filament Database. Vérifiez les champs avant d'enregistrer.",
      materialCount: '{{count}} matériau(x)',
      filamentCount: '{{count}} filament(s)',
      variantCount: '{{count}} couleur(s)',
    ...
    nextSlot: {
      action: 'Affecter au prochain slot AMS chargé',
      badge: 'Prochain slot sur {{printer}}',
      badgeTitle: 'En attente du prochain slot AMS chargé. Expire à {{expires}}.',
      anyPrinter: "n'importe quelle imprimante",
      cancel: "Annuler l'affectation au prochain slot",
      cancelled: 'Affectation au prochain slot annulée',
      cancelError: "Impossible d'annuler l'affectation au prochain slot",
      modalTitle: 'Affecter au prochain slot chargé',
      modalIntro: "Chargez {{spool}} dans un slot AMS libre de l'imprimante ci-dessous. Dès que l'imprimante le signale, le slot est affecté à cette bobine, réglages de filament compris.",
      printerLabel: 'Imprimante',
      timeoutLabel: 'Attendre au maximum',
      timeoutOptions: {
        m15: '15 minutes',
        m30: '30 minutes',
        h2: '2 heures',
      ...
      rfidNote: "Une bobine Bambu Lab dont l'étiquette RFID appartient déjà à une autre bobine de l'inventaire conserve cette entrée ; la demande attend alors le prochain slot.",
      submit: 'Attendre le prochain slot',
      submitting: 'Enregistrement...',
      created: 'En attente du prochain slot chargé sur {{printer}}',
      createError: "Impossible de créer l'affectation au prochain slot",
      completedToast: 'Bobine affectée à {{printer}} {{slot}}',
      timedOutToast: "Une affectation au prochain slot a expiré avant qu'une bobine ne soit chargée",
      fromSlotDialog: 'Prochain slot chargé à la place',
    },
  ...
  printModal: {
    ...
    jobNamePlaceholder: 'ex. Commande 1234',
    jobNameHint: "Nomme le fichier envoyé à l'imprimante, pour que son écran affiche ceci plutôt que le nom du modèle.",
  ...
  smartPlugs: {
    ...
    moonrakerDevice: "Appareil d'alimentation",
    moonrakerDeviceHelp: "Un appareil [power] du Moonraker de l'imprimante. L'adresse et la clé API viennent de l'imprimante : les modifier là-bas ne casse pas cette prise.",
    moonrakerPickPrinter: "Choisissez d'abord une imprimante Klipper ci-dessous.",
    moonrakerSelectDevice: 'Choisir un appareil…',
    moonrakerNoDevices: "Le Moonraker de cette imprimante n'a aucun appareil [power] configuré.",
    moonrakerDevicesFailed: "Impossible de lire les appareils d'alimentation depuis Moonraker.",
    moonrakerPrinterRequired: 'Choisissez une imprimante Klipper pour cet appareil',
    moonrakerDeviceRequired: "Choisissez un appareil d'alimentation",
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: "Notifications push iOS via l'application Notify, avec une tuile de progression d'impression en direct dans la Dynamic Island",
    },
    ...
    printAlmostDone: 'Bientôt terminée',
    printAlmostDoneDescription: "Notifier à 97 % avec une capture de la caméra, pour retirer les pièces dès la fin de l'impression",
    printerOffline: 'Imprimante hors ligne',
    ...
    printAlmostDoneHint: '(97 %, avec capture de la caméra)',
