export default {
  ...
  printers: {
    ...
    tv: {
      title: 'Stamperia',
      backToApp: 'Torna a Bambuddy',
      tokenRejected: 'Questo link TV non è più valido. Il token è scaduto o è stato revocato.',
      refreshInterval: 'Aggiornamento',
      everySeconds: 'ogni {{seconds}}s',
      cameras: 'Telecamere',
      total: '{{count}} stampanti',
      currentJob: 'Lavoro corrente',
      unnamedJob: 'Stampa in corso',
      progress: 'Avanzamento stampa',
      eta: 'Fine {{time}}',
      idleHint: {
        idle: 'Pronta a stampare',
        finished: 'Stampa finita, piatto non ancora liberato',
    ...
    toast: {
      ...
      historyImported_one: '{{count}} stampa importata',
      historyImported_other: '{{count}} stampe importate',
      historyNothingNew: 'Nessuna nuova stampa da importare',
      historyImportFailed: 'Impossibile importare la cronologia delle stampe',
    ...
    modal: {
      ...
      providerLabel: 'Tipo di stampante',
      providerBambu: 'Bambu Lab',
      providerKlipper: 'Klipper (Moonraker)',
      moonrakerUrl: 'URL Moonraker',
      moonrakerUrlHelp: 'L’indirizzo di Mainsail o Fluidd, ad es. http://voron.local o http://192.168.1.50. Numero di serie e IP vengono ricavati da esso.',
      moonrakerApiKey: 'Chiave API Moonraker (opzionale)',
      chamberObject: 'Sensore della camera',
      chamberObjectAuto: 'Automatico',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: 'Quale oggetto Klipper riporta la camera. La modalità automatica cerca un oggetto chiamato chamber; scegli il tuo se ha un altro nome.',
      chamberObjectUsing: 'La modalità automatica ha trovato {{name}}.',
      transport: 'Aggiornamenti di stato',
      transportAuto: 'Push, con polling di riserva',
      transportPoll: 'Solo polling',
      transportHelp: 'Gli aggiornamenti push arrivano dal WebSocket di Moonraker e raggiungono la scheda in molto meno di un secondo. Il polling continua comunque: scegli solo polling se qualcosa fra Bambuddy e la stampante rifiuta le connessioni WebSocket.',
      moonrakerApiKeyHelp: 'Necessaria solo se Moonraker richiede l’autenticazione per questo host.',
      klipperModelPlaceholder: 'ad es. Voron 2.4 350',
      importHistory: 'Cronologia stampe',
      importHistoryButton: 'Importa da Moonraker',
      importHistoryHelp: "Aggiunge all'archivio ogni stampa che Moonraker ha registrato, senza i file. Le stampe già importate vengono saltate, quindi puoi ripetere l'operazione senza problemi.",
    ...
    discovery: {
      ...
      scanKlipper: 'Cerca stampanti Klipper nella rete',
    ...
    firmwareSystemPackages_one: 'sistema: {{count}} aggiornamento pacchetto',
    firmwareSystemPackages_other: 'sistema: {{count}} aggiornamenti pacchetti',
    ...
    printSource: {
      title: 'Scegli un file da stampare',
      hint: 'Stampa su {{printer}} — scegli un file dalla libreria o caricane uno nuovo',
  ...
  archives: {
    ...
    card: {
      ...
      layer: '{{count}} strato',
      layers: '{{count}} strati',
      priceTitle: 'Prezzo suggerito. Costo {{cost}}, margine {{margin}}.',
      priceFloor: 'minimo',
  ...
  settings: {
    ...
    openFilamentDatabase: 'Cerca bobine tramite Open Filament Database',
    openFilamentDatabaseDesc: 'Aggiunge al modulo di aggiunta bobina una ricerca che precompila marca, materiale, colore, peso e temperature da openfilamentdatabase.org. Quando la usi, Bambuddy contatta quel sito dal backend.',
    ...
    pricingEnabled: 'Prezzo di vendita suggerito',
    pricingEnabledDescription: 'Mostra a quanto dovrebbe essere venduta una stampa archiviata, partendo dal costo di filamento ed energia. Separato dalla fatturazione, che addebita le stampe a un centro di costo.',
    pricingLabourPerHour: 'Manodopera per ora di stampa',
    pricingMarkup: 'Moltiplicatore',
    pricingFloor: 'Prezzo minimo',
    pricingReference: 'Una tua stampa tipica costa {{cost}} da produrre, su {{samples}} stampe degli ultimi {{days}} giorni.',
    pricingReferenceEmpty: 'Nessuna stampa con costo finora, quindi non esiste un costo tipico con cui confrontare un moltiplicatore.',
  ...
  printerFiles: {
    printOnPrinter: 'Avvia sulla stampante',
    printStarted: 'Stampa avviata sulla stampante',
    printFailed: 'Impossibile avviare la stampa: {{error}}',
  ...
  farm: {
    ...
    subtitle: 'Panoramica in tempo reale della tua stamperia',
    ...
    noPrintersMatch: 'Nessuna stampante corrisponde ai filtri.',
    activeProjects: 'Progetti attivi',
    viewAllProjects: 'Tutti i progetti',
    noActiveProjects: 'Nessun progetto attivo al momento.',
    totalCount: '{{count}} in totale',
    onlineCount: '{{count}} online',
    offlineCount: '{{count}} offline',
    allOperational: 'Tutto funziona',
    needAttention_one: '{{count}} elemento richiede attenzione',
    needAttention_other: '{{count}} elementi richiedono attenzione',
    noIssues: 'Nessun problema attivo',
    openAlerts: 'Apri l’elenco degli avvisi',
    filamentStock: 'Scorte di filamento',
    spoolsLow_one: '{{count}} bobina quasi esaurita',
    spoolsLow_other: '{{count}} bobine quasi esaurite',
    maintenance: 'Manutenzione',
    maintenanceDue_one: '{{count}} intervento di manutenzione richiede attenzione',
    maintenanceDue_other: '{{count}} interventi di manutenzione richiedono attenzione',
    state: {
      printing: 'In stampa',
      paused: 'In pausa',
      idle: 'Inattiva',
    ...
    stats: {
      ...
      paused: 'In pausa',
      alerts: 'Avvisi',
      partsToday: 'Pezzi oggi',
      ofFleet: '{{percent}}% della flotta',
      alertsSub: 'Stampanti, scorte, manutenzione',
      queueTracked_one: '{{count}} elemento in coda',
      queueTracked_other: '{{count}} elementi in coda',
    },
    project: {
    ...
    alerts: {
      title: 'Avvisi',
      subtitle: 'Stampanti, filamento e manutenzione che richiedono attenzione.',
      empty: 'Al momento non serve fare nulla.',
      printerError: 'La stampante segnala un errore',
      printerPaused: 'In pausa - potrebbe servire un intervento',
      printerOffline: 'Offline o non raggiungibile',
      spoolLow: '{{percent}}% di filamento rimasto',
      maintenance: '{{item}}',
    },
    groups: {
      title: 'Gruppi di stampanti',
      subtitle: 'Raggruppa le stampanti per organizzarle nel centro di comando.',
      nameLabel: 'Nome del gruppo',
      current: 'Gruppi attuali',
      printerCount_one: '{{count}} stampante',
      printerCount_other: '{{count}} stampanti',
      save: 'Salva gruppo',
    },
  },
  projects: {
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: 'Scegli marca, materiale, filamento e colore per precompilare questa bobina. Tutti i campi restano modificabili.',
      brandLabel: 'Marca',
      brandPlaceholder: 'Cerca marche OFDB...',
      brandLoadFailed: 'Impossibile caricare le marche da Open Filament Database',
      noBrands: 'Nessuna marca trovata in Open Filament Database.',
      materialLabel: 'Materiale',
      materialLoadFailed: 'Impossibile caricare i materiali di questa marca',
      noMaterials: 'Questa marca non ha materiali elencati.',
      filamentLabel: 'Filamento',
      filamentPlaceholder: 'Filtra filamenti...',
      searchFailed: 'Impossibile caricare i filamenti per questa marca e questo materiale',
      noFilaments: 'Nessun filamento elencato per questa marca e questo materiale.',
      filamentLoadFailed: 'Impossibile caricare i dettagli del filamento',
      noVariants: 'Questo filamento non ha colori elencati.',
      variantLabel: 'Colore',
      variantLoadFailed: 'Impossibile caricare i dettagli del colore',
      applied: 'Precompilato da Open Filament Database. Controlla i campi prima di salvare.',
      materialCount: '{{count}} materiale/i',
      filamentCount: '{{count}} filamento/i',
      variantCount: '{{count}} colore/i',
      sizeCount: '{{count}} misura/e',
    },
    ...
    nextSlot: {
      action: 'Assegna al prossimo slot AMS caricato',
      badge: 'Prossimo slot su {{printer}}',
      badgeTitle: 'In attesa del prossimo slot AMS caricato. Scade alle {{expires}}.',
      anyPrinter: 'qualsiasi stampante',
      cancel: "Annulla l'assegnazione al prossimo slot",
      cancelled: 'Assegnazione al prossimo slot annullata',
      cancelError: "Impossibile annullare l'assegnazione al prossimo slot",
      modalTitle: 'Assegna al prossimo slot caricato',
      modalIntro: 'Carica {{spool}} in uno slot AMS libero della stampante qui sotto. Appena la stampante lo segnala, lo slot viene assegnato a questa bobina, impostazioni filamento incluse.',
      printerLabel: 'Stampante',
      timeoutLabel: 'Attendi al massimo',
      timeoutOptions: {
        m15: '15 minuti',
        m30: '30 minuti',
        h2: '2 ore',
      ...
      rfidNote: "Una bobina Bambu Lab il cui tag RFID appartiene già a un'altra bobina dell'inventario mantiene quella voce; la richiesta attende quindi il prossimo slot.",
      submit: 'Attendi il prossimo slot',
      submitting: 'Salvataggio...',
      created: 'In attesa del prossimo slot caricato su {{printer}}',
      createError: "Impossibile creare l'assegnazione al prossimo slot",
      completedToast: 'Bobina assegnata a {{printer}} {{slot}}',
      timedOutToast: "Un'assegnazione al prossimo slot è scaduta prima che venisse caricata una bobina",
      fromSlotDialog: 'Prossimo slot caricato invece',
    },
  ...
  printModal: {
    ...
    jobNamePlaceholder: 'es. Ordine 1234',
    jobNameHint: 'Dà il nome al file inviato alla stampante, così il suo display mostra questo invece del nome del modello.',
  ...
  smartPlugs: {
    ...
    moonrakerDevice: 'Dispositivo di alimentazione',
    moonrakerDeviceHelp: 'Un dispositivo [power] dal Moonraker della stampante. Indirizzo e chiave API arrivano dalla stampante, quindi modificarli lì non rompe questa presa.',
    moonrakerPickPrinter: 'Scegli prima una stampante Klipper qui sotto.',
    moonrakerSelectDevice: 'Scegli un dispositivo…',
    moonrakerNoDevices: 'Il Moonraker di questa stampante non ha dispositivi [power] configurati.',
    moonrakerDevicesFailed: 'Impossibile leggere i dispositivi di alimentazione da Moonraker.',
    moonrakerPrinterRequired: 'Scegli una stampante Klipper per questo dispositivo',
    moonrakerDeviceRequired: 'Scegli un dispositivo di alimentazione',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: "Notifiche push iOS tramite l'app Notify, con un riquadro live dell'avanzamento di stampa nella Dynamic Island",
    },
    ...
    printAlmostDone: 'Quasi finita',
    printAlmostDoneDescription: 'Avvisa al 97 % con uno scatto della fotocamera, così i pezzi si possono togliere appena la stampa finisce',
    printerOffline: 'Stampante offline',
    printerError: 'Errore stampante',
    ...
    printAlmostDoneHint: '(97 %, con scatto della fotocamera)',
