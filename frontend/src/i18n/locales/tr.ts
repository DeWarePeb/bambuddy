export default {
  ...
  printers: {
    ...
    toast: {
      ...
      historyImported_one: '{{count}} baskı içe aktarıldı',
      historyImported_other: '{{count}} baskı içe aktarıldı',
      historyNothingNew: 'İçe aktarılacak yeni baskı yok',
      historyImportFailed: 'Baskı geçmişi içe aktarılamadı',
    ...
    modal: {
      ...
      chamberObject: 'Hazne sensörü',
      chamberObjectAuto: 'Otomatik',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: 'Hazne sıcaklığını hangi Klipper nesnesinin bildirdiği. Otomatik seçenek chamber adlı bir nesne arar; sizinki başka adlandırıldıysa onu seçin.',
      chamberObjectUsing: 'Otomatik olarak {{name}} bulundu.',
      transport: 'Durum güncellemeleri',
      transportAuto: 'Anlık, yedek olarak yoklama',
      transportPoll: 'Yalnızca yoklama',
      transportHelp: "Anlık güncellemeler Moonraker'ın WebSocket bağlantısıyla gelir ve karta bir saniyenin çok altında ulaşır. Yoklama her durumda sürer; yalnızca yoklamayı, Bambuddy ile yazıcı arasındaki bir şey WebSocket bağlantılarını engelliyorsa seçin.",
      ...
      importHistory: 'Baskı geçmişi',
      importHistoryButton: "Moonraker'dan içe aktar",
      importHistoryHelp: "Moonraker'ın kaydettiği her baskıyı dosyasız olarak arşive ekler. Daha önce aktarılan baskılar atlanır, bu yüzden tekrar çalıştırmak sorun değildir.",
    ...
    discovery: {
      ...
      scanKlipper: 'Ağda Klipper Yazıcıları Ara',
  ...
  archives: {
    ...
    card: {
      ...
      layer: '{{count}} katman',
      layers: '{{count}} katman',
      priceTitle: 'Önerilen fiyat. Maliyet {{cost}}, kâr marjı {{margin}}.',
      priceFloor: 'alt sınır',
      object: '{{count}} nesne',
      objects: '{{count}} nesne',
  ...
  settings: {
    ...
    openFilamentDatabase: 'Makaraları Open Filament Database üzerinden ara',
    openFilamentDatabaseDesc: 'Makara ekleme formuna, marka, malzeme, renk, ağırlık ve sıcaklıkları openfilamentdatabase.org üzerinden dolduran bir arama ekler. Kullandığınızda Bambuddy bu siteyi arka uçtan çağırır.',
    ...
    pricingEnabled: 'Önerilen satış fiyatı',
    pricingEnabledDescription: 'Arşivlenmiş bir baskının filament ve enerji maliyetinden yola çıkarak kaça satılması gerektiğini gösterir. Baskıları bir masraf merkezine yazan faturalandırmadan ayrıdır.',
    pricingLabourPerHour: 'Baskı saati başına işçilik',
    pricingMarkup: 'Çarpan',
    pricingFloor: 'En düşük fiyat',
    pricingReference: 'Son {{days}} gündeki {{samples}} baskıya göre, tipik bir baskınızın maliyeti {{cost}}.',
    pricingReferenceEmpty: 'Henüz maliyeti hesaplanmış baskı yok, dolayısıyla çarpanı karşılaştıracak tipik bir maliyet de yok.',
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: 'Bu makarayı önceden doldurmak için marka, malzeme, filament ve renk seçin. Tüm alanlar düzenlenebilir kalır.',
      brandLabel: 'Marka',
      brandPlaceholder: 'OFDB markalarında ara...',
      brandLoadFailed: 'Markalar Open Filament Database üzerinden yüklenemedi',
      noBrands: 'Open Filament Database içinde marka bulunamadı.',
      materialLabel: 'Malzeme',
      materialLoadFailed: 'Bu markanın malzemeleri yüklenemedi',
      noMaterials: 'Bu marka için listelenmiş malzeme yok.',
      filamentLabel: 'Filament',
      filamentPlaceholder: 'Filamentleri filtrele...',
      searchFailed: 'Bu marka ve malzeme için filamentler yüklenemedi',
      noFilaments: 'Bu marka ve malzeme için listelenmiş filament yok.',
      filamentLoadFailed: 'Filament ayrıntıları yüklenemedi',
      noVariants: 'Bu filament için listelenmiş renk yok.',
      variantLabel: 'Renk',
      variantLoadFailed: 'Renk ayrıntıları yüklenemedi',
      applied: 'Open Filament Database üzerinden dolduruldu. Kaydetmeden önce alanları kontrol edin.',
      materialCount: '{{count}} malzeme',
      filamentCount: '{{count}} filament',
      variantCount: '{{count}} renk',
      sizeCount: '{{count}} boyut',
    },
    ...
    nextSlot: {
      action: 'Sonraki yüklenen AMS yuvasına ata',
      badge: '{{printer}} üzerinde sonraki yuva',
      badgeTitle: 'Sonraki yüklenen AMS yuvası bekleniyor. {{expires}} tarihinde sona erer.',
      anyPrinter: 'herhangi bir yazıcı',
      cancel: 'Sonraki yuva atamasını iptal et',
      cancelled: 'Sonraki yuva ataması iptal edildi',
      cancelError: 'Sonraki yuva ataması iptal edilemedi',
      modalTitle: 'Sonraki yüklenen yuvaya ata',
      modalIntro: '{{spool}} makarasını aşağıdaki yazıcının boş bir AMS yuvasına takın. Yazıcı bunu bildirdiği anda yuva, filament ayarlarıyla birlikte bu makaraya atanır.',
      printerLabel: 'Yazıcı',
      timeoutLabel: 'En fazla bekle',
      timeoutOptions: {
        m15: '15 dakika',
        m30: '30 dakika',
        h2: '2 saat',
      ...
      rfidNote: 'RFID etiketi envanterdeki başka bir makaraya ait olan bir Bambu Lab makarası o kaydı korur; bu istek de sonraki yuvayı beklemeye devam eder.',
      submit: 'Sonraki yuvayı bekle',
      submitting: 'Kaydediliyor...',
      created: '{{printer}} üzerinde sonraki yüklenen yuva bekleniyor',
      createError: 'Sonraki yuva ataması oluşturulamadı',
      completedToast: 'Makara {{printer}} {{slot}} yuvasına atandı',
      timedOutToast: 'Bir makara yüklenmeden önce sonraki yuva ataması sona erdi',
      fromSlotDialog: 'Bunun yerine sonraki yüklenen yuva',
    },
  ...
  printModal: {
    ...
    jobName: 'İş adı',
    jobNamePlaceholder: 'ör. Sipariş 1234',
    jobNameHint: 'Yazıcıya gönderilen dosyayı adlandırır; böylece ekranında model adı yerine bu görünür.',
  ...
  smartPlugs: {
    ...
    moonrakerDevice: 'Güç cihazı',
    moonrakerDeviceHelp: "Yazıcının kendi Moonraker'ındaki bir [power] cihazı. Adres ve API anahtarı yazıcıdan gelir; onları orada değiştirmek bu prizi bozmaz.",
    moonrakerPickPrinter: 'Önce aşağıdan bir Klipper yazıcı seçin.',
    moonrakerSelectDevice: 'Bir cihaz seçin…',
    moonrakerNoDevices: "Bu yazıcının Moonraker'ında yapılandırılmış [power] cihazı yok.",
    moonrakerDevicesFailed: "Güç cihazları Moonraker'dan okunamadı.",
    moonrakerPrinterRequired: 'Bu güç cihazı için bir Klipper yazıcı seçin',
    moonrakerDeviceRequired: 'Bir güç cihazı seçin',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: 'Notify uygulaması üzerinden iOS anlık bildirimleri; Dynamic Island içinde canlı baskı ilerleme kutucuğu gösterir',
    },
    ...
    printAlmostDone: 'Neredeyse bitti',
    printAlmostDoneDescription: '%97 seviyesinde kamera görüntüsüyle bildir, böylece baskı biter bitmez parçalar alınabilir',
    printerOffline: 'Yazıcı Çevrimdışı',
    printerError: 'Yazıcı Hatası',
    ...
    printAlmostDoneHint: '(%97, kamera görüntüsüyle)',
