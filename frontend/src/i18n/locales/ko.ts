export default {
  ...
  printers: {
    ...
    tv: {
      title: '프린트 팜',
      backToApp: 'Bambuddy로 돌아가기',
      tokenRejected: '이 TV 링크는 더 이상 유효하지 않습니다. 토큰이 만료되었거나 취소되었습니다.',
      refreshInterval: '새로 고침',
    ...
    console: {
      title: '매크로와 콘솔',
      searchMacros: '매크로 검색',
      noMacros: '이 프린터에는 매크로가 없습니다',
      emptyLog: '프린터 로그가 아직 비어 있습니다',
      placeholder: 'G-code 명령을 입력하세요',
      send: '보내기',
      printingWarning: '출력이 진행 중입니다. 여기서 보낸 명령은 출력 중인 프린터에 전달됩니다 — 그래도 보내려면 선택하세요.',
      confirmRequired: '출력이 진행 중입니다 — 위에서 확인하면 보낼 수 있습니다',
      sendFailed: '프린터가 명령을 거부했습니다: {{error}}',
      unavailable: '프린터에 연결할 수 없습니다',
    },
    ...
    modal: {
      ...
      providerLabel: '프린터 유형',
      providerBambu: 'Bambu Lab',
      providerKlipper: 'Klipper (Moonraker)',
      moonrakerUrl: 'Moonraker URL',
      moonrakerUrlHelp: 'Mainsail 또는 Fluidd 주소(예: http://voron.local 또는 http://192.168.1.50). 시리얼 번호와 IP는 여기에서 파생됩니다.',
      moonrakerApiKey: 'Moonraker API 키(선택)',
      chamberObject: '챔버 센서',
      chamberObjectAuto: '자동',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: '챔버 온도를 보고하는 Klipper 객체입니다. 자동은 chamber라는 이름을 찾습니다. 다른 이름이라면 직접 선택하세요.',
      chamberObjectUsing: '자동으로 {{name}}을(를) 찾았습니다.',
      transport: '상태 업데이트',
      transportAuto: '푸시, 폴링을 예비로 사용',
      transportPoll: '폴링만 사용',
      transportHelp: '푸시 업데이트는 Moonraker의 WebSocket으로 전달되어 1초가 채 되기 전에 카드에 반영됩니다. 어느 쪽이든 폴링은 계속되므로, Bambuddy와 프린터 사이에서 WebSocket 연결을 막는 장비가 있을 때만 폴링만 사용을 선택하세요.',
      moonrakerApiKeyHelp: '이 호스트에서 Moonraker가 인증을 요구할 때만 필요합니다.',
      klipperModelPlaceholder: '예: Voron 2.4 350',
      importHistory: '출력 기록',
      importHistoryButton: 'Moonraker에서 가져오기',
      importHistoryHelp: 'Moonraker가 기억하는 모든 작업을 파일 없이 아카이브에 추가합니다. 이미 가져온 작업은 건너뛰므로 다시 실행해도 안전합니다.',
      saveChanges: '변경사항 저장'
    },
    skipObjects: {
      tooltip: '객체 건너뛰기',
    ...
    discovery: {
      ...
      scanKlipper: '네트워크에서 Klipper 프린터 검색',
  ...
  archives: {
    ...
    card: {
      ...
      layer: '{{count}}층',
      layers: '{{count}}층',
      priceTitle: '권장 가격. 비용 {{cost}}, 마진 {{margin}}.',
      priceFloor: '하한',
      object: '{{count}}개 객체',
      objects: '{{count}}개 객체',
  ...
  settings: {
    ...
    openFilamentDatabase: 'Open Filament Database로 스풀 검색',
    openFilamentDatabaseDesc: '스풀 추가 양식에 검색 기능을 추가하여 openfilamentdatabase.org에서 브랜드, 소재, 색상, 무게, 온도를 미리 채웁니다. 사용할 때 Bambuddy가 백엔드에서 해당 사이트를 호출합니다.',
    ...
    pricingEnabled: '권장 판매 가격',
    pricingEnabledDescription: '보관된 인쇄물을 필라멘트비와 전기요금을 기준으로 얼마에 팔아야 하는지 표시합니다. 인쇄를 코스트 센터에 청구하는 과금 기능과는 별개입니다.',
    pricingLabourPerHour: '인쇄 시간당 인건비',
    pricingMarkup: '배수',
    pricingFloor: '최저 가격',
    pricingReference: '최근 {{days}}일간 {{samples}}건의 인쇄를 기준으로, 일반적인 인쇄의 제작 비용은 {{cost}}입니다.',
    pricingReferenceEmpty: '아직 비용이 기록된 인쇄가 없어 배수를 견줄 기준 비용이 없습니다.',
  ...
  printerFiles: {
    printOnPrinter: '프린터에서 시작',
    printStarted: '프린터에서 출력을 시작했습니다',
    printFailed: '출력을 시작할 수 없습니다: {{error}}',
  ...
  farm: {
    ...
    createGroup: '그룹 만들기',
    ungrouped: '그룹 없음',
    noPrintersMatch: '조건에 맞는 프린터가 없습니다.',
    activeProjects: '진행 중인 프로젝트',
    viewAllProjects: '모든 프로젝트',
    noActiveProjects: '현재 추적 중인 프로젝트가 없습니다.',
    totalCount: '전체 {{count}}대',
    onlineCount: '온라인 {{count}}대',
    offlineCount: '오프라인 {{count}}대',
    allOperational: '모두 정상',
    needAttention_one: '{{count}}건이 확인이 필요합니다',
    needAttention_other: '{{count}}건이 확인이 필요합니다',
    noIssues: '진행 중인 문제 없음',
    openAlerts: '알림 목록 열기',
    filamentStock: '필라멘트 재고',
    spoolsLow_one: '스풀 {{count}}개 잔량 부족',
    spoolsLow_other: '스풀 {{count}}개 잔량 부족',
    maintenance: '유지보수',
    maintenanceDue_one: '유지보수 {{count}}건이 확인이 필요합니다',
    maintenanceDue_other: '유지보수 {{count}}건이 확인이 필요합니다',
    state: {
      printing: '출력 중',
      paused: '일시정지',
      idle: '대기',
    ...
    stats: {
      ...
      partsToday: '오늘 부품',
      ofFleet: '전체의 {{percent}}%',
      alertsSub: '프린터, 재고, 유지보수',
      queueTracked_one: '대기열 {{count}}건',
      queueTracked_other: '대기열 {{count}}건',
    },
    project: {
      queued: '대기 {{count}}건',
      failed: '실패 {{count}}건',
    ...
    alerts: {
      title: '알림',
      subtitle: '확인이 필요한 프린터, 필라멘트, 유지보수 항목입니다.',
      empty: '지금은 확인이 필요한 항목이 없습니다.',
      printerError: '프린터에서 오류가 보고되었습니다',
      printerPaused: '일시정지 - 조치가 필요할 수 있습니다',
      printerOffline: '오프라인이거나 연결할 수 없습니다',
      spoolLow: '필라멘트 {{percent}}% 남음',
      maintenance: '{{item}}',
    },
    groups: {
      title: '프린터 그룹',
      subtitle: '커맨드 센터에서 묶어 보려면 프린터를 그룹으로 만드세요.',
      nameLabel: '그룹 이름',
      current: '현재 그룹',
      printerCount_one: '프린터 {{count}}대',
      printerCount_other: '프린터 {{count}}대',
      save: '그룹 저장',
    },
  },
  projects: {
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: '브랜드, 소재, 필라멘트, 색상을 선택하면 이 스풀의 값이 미리 채워집니다. 모든 항목은 계속 편집할 수 있습니다.',
      brandLabel: '브랜드',
      brandPlaceholder: 'OFDB 브랜드 검색...',
      brandLoadFailed: 'Open Filament Database에서 브랜드를 불러오지 못했습니다',
      noBrands: 'Open Filament Database에서 브랜드를 찾을 수 없습니다.',
      materialLabel: '소재',
      materialLoadFailed: '이 브랜드의 소재를 불러오지 못했습니다',
      noMaterials: '이 브랜드에는 등록된 소재가 없습니다.',
      filamentLabel: '필라멘트',
      filamentPlaceholder: '필라멘트 필터...',
      searchFailed: '이 브랜드와 소재의 필라멘트를 불러오지 못했습니다',
      noFilaments: '이 브랜드와 소재에 등록된 필라멘트가 없습니다.',
      filamentLoadFailed: '필라멘트 상세 정보를 불러오지 못했습니다',
      noVariants: '이 필라멘트에는 등록된 색상이 없습니다.',
      variantLabel: '색상',
      variantLoadFailed: '색상 상세 정보를 불러오지 못했습니다',
      applied: 'Open Filament Database에서 미리 채웠습니다. 저장하기 전에 항목을 확인하세요.',
      materialCount: '소재 {{count}}개',
      filamentCount: '필라멘트 {{count}}개',
      variantCount: '색상 {{count}}개',
      sizeCount: '규격 {{count}}개',
    },
    addSpool: '스풀 추가',
    editSpool: '스풀 편집',
    copySpool: '스풀 복사',
    ...
    nextSlot: {
      action: '다음에 장착되는 AMS 슬롯에 배정',
      badge: '{{printer}}의 다음 슬롯',
      badgeTitle: '다음에 장착되는 AMS 슬롯을 기다리는 중입니다. {{expires}}에 만료됩니다.',
      anyPrinter: '모든 프린터',
      cancel: '다음 슬롯 배정 취소',
      cancelled: '다음 슬롯 배정이 취소되었습니다',
      cancelError: '다음 슬롯 배정을 취소하지 못했습니다',
      modalTitle: '다음에 장착되는 슬롯에 배정',
      modalIntro: '아래 프린터의 빈 AMS 슬롯에 {{spool}}을(를) 장착하세요. 프린터가 이를 보고하는 즉시 해당 슬롯이 이 스풀에 배정되며 필라멘트 설정도 함께 적용됩니다.',
      printerLabel: '프린터',
      timeoutLabel: '최대 대기 시간',
      timeoutOptions: {
        m15: '15분',
        m30: '30분',
        h2: '2시간',
      ...
      rfidNote: 'RFID 태그가 이미 재고의 다른 스풀에 연결된 Bambu Lab 스풀은 기존 항목을 유지하며, 이 요청은 그대로 다음 슬롯을 기다립니다.',
      submit: '다음 슬롯 대기',
      submitting: '저장 중...',
      created: '{{printer}}에서 다음에 장착되는 슬롯을 기다리는 중',
      createError: '다음 슬롯 배정을 생성하지 못했습니다',
      completedToast: '스풀을 {{printer}} {{slot}}에 배정했습니다',
      timedOutToast: '스풀이 장착되기 전에 다음 슬롯 배정이 만료되었습니다',
      fromSlotDialog: '대신 다음에 장착되는 슬롯',
    },
  ...
  printModal: {
    ...
    jobName: '작업 이름',
    jobNamePlaceholder: '예: 주문 1234',
    jobNameHint: '프린터로 보내는 파일의 이름이 되어, 프린터 화면에 모델 이름 대신 이 이름이 표시됩니다.',
  ...
  smartPlugs: {
    ...
    moonrakerDevice: '전원 장치',
    moonrakerDeviceHelp: '프린터 자체 Moonraker의 [power] 장치입니다. 주소와 API 키는 프린터에서 가져오므로 그쪽을 바꿔도 이 플러그는 계속 동작합니다.',
    moonrakerPickPrinter: '먼저 아래에서 Klipper 프린터를 선택하세요.',
    moonrakerSelectDevice: '장치 선택…',
    moonrakerNoDevices: '이 프린터의 Moonraker에 설정된 [power] 장치가 없습니다.',
    moonrakerDevicesFailed: 'Moonraker에서 전원 장치를 읽지 못했습니다.',
    moonrakerPrinterRequired: '이 전원 장치에 사용할 Klipper 프린터를 선택하세요',
    moonrakerDeviceRequired: '전원 장치를 선택하세요',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: 'Notify 앱을 통한 iOS 푸시 알림으로, Dynamic Island에 실시간 인쇄 진행률 타일을 표시합니다',
    },
    ...
    printAlmostDone: '거의 완료',
    printAlmostDoneDescription: '97%에서 카메라 스냅샷과 함께 알려 인쇄가 끝나는 즉시 부품을 꺼낼 수 있게 합니다',
    printerOffline: '프린터 오프라인',
    printerError: '프린터 오류',
    ...
    printAlmostDoneHint: '(97%, 카메라 스냅샷 포함)',
  ...
  cameraTokens: {
    ...
    create: {
      ...
      hintTv:
        'TV 토큰은 로그인 없이 /tv를 엽니다 — 벽걸이 디스플레이나 키오스크 모드의 Pi 같은 화면용입니다. 모든 프린터의 상태, 출력 중인 파일, 진행률, 장착된 스풀과 카메라 스냅샷을 볼 수 있습니다. 주소나 접근 코드는 볼 수 없습니다.',
      title: '새 토큰 만들기',
      nameLabel: '토큰 이름',
    ...
    created: {
      ...
      tvUrlTitle: '이 화면용 TV URL',
      tvUrlHint:
        '이 주소를 화면에서 여세요. &cams=0을 붙이면 카메라 화면을 숨기고, &refresh=10으로 갱신 주기를 바꿀 수 있습니다. URL을 읽을 수 있는 사람은 누구나 화면을 볼 수 있으므로 열쇠처럼 다루고, 차단하려면 토큰을 취소하세요.',
