export default {
  // Voron patch series (B5): o aviso "precisa de atenção"
  alerts: {
    title: 'Precisa de atenção',
    maintenanceDue_one: '{{count}} manutenção pendente',
    maintenanceDue_other: '{{count}} manutenções pendentes',
    lowStock_one: '{{count}} bobina acabando',
    lowStock_other: '{{count}} bobinas acabando',
    printerFaults_one: '{{count}} impressora com falha',
    printerFaults_other: '{{count}} impressoras com falha',
    more: '+{{count}} outros',
    spoolLow: '{{spool}} ({{percent}}%)',
    spoolLowOn: '{{spool}} ({{percent}}%, em {{printer}})',
    openMaintenance: 'Abrir Manutenção',
    openInventory: 'Abrir Filamento',
    openPrinters: 'Abrir Impressoras',
    dismiss: 'Ocultar até algo mudar',
  },
  // Navigation
  nav: {
    farm: 'Centro de comando',
  ...
  printers: {
    ...
    tv: {
      title: 'Oficina de impressão',
      backToApp: 'Voltar ao Bambuddy',
      tokenRejected: 'Este link de TV não é mais válido. O token expirou ou foi revogado.',
      refreshInterval: 'Atualizar',
      everySeconds: 'a cada {{seconds}}s',
      cameras: 'Câmeras',
      total: '{{count}} impressoras',
      currentJob: 'Trabalho atual',
      unnamedJob: 'Impressão ativa',
      progress: 'Progresso da impressão',
      eta: 'Fim {{time}}',
      idleHint: {
        idle: 'Pronta para imprimir',
        finished: 'Impressão concluída, mesa ainda não liberada',
    ...
    toast: {
      ...
      historyImported_one: '{{count}} impressão importada',
      historyImported_other: '{{count}} impressões importadas',
      historyNothingNew: 'Nenhuma impressão nova para importar',
      historyImportFailed: 'Não foi possível importar o histórico de impressões',
    ...
    // Connection status
    connection: {
      klippyShutdown: 'Klipper desligado',
      klippyError: 'Erro do Klipper',
      klippyStartup: 'Klipper iniciando',
      klippyDisconnected: 'Klipper não está em execução',
      connected: 'Conectado',
      offline: 'Offline',
    },
    plateStatus: {
    ...
    modal: {
      ...
      providerLabel: 'Tipo de impressora',
      providerBambu: 'Bambu Lab',
      providerKlipper: 'Klipper (Moonraker)',
      moonrakerUrl: 'URL do Moonraker',
      moonrakerUrlHelp: 'O endereço do Mainsail ou Fluidd, p. ex. http://voron.local ou http://192.168.1.50. Número de série e IP são derivados dele.',
      moonrakerApiKey: 'Chave de API do Moonraker (opcional)',
      chamberObject: 'Sensor da câmara',
      chamberObjectAuto: 'Automático',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: 'Qual objeto do Klipper informa a câmara. O modo automático procura um chamado chamber; escolha o seu se tiver outro nome.',
      chamberObjectUsing: 'O modo automático encontrou {{name}}.',
      transport: 'Atualizações de status',
      transportAuto: 'Push, com sondagem de reserva',
      transportPoll: 'Somente sondagem',
      transportHelp: 'As atualizações push chegam pelo WebSocket do Moonraker e aparecem no cartão em bem menos de um segundo. A sondagem continua de qualquer forma; escolha somente sondagem se algo entre o Bambuddy e a impressora recusar conexões WebSocket.',
      moonrakerApiKeyHelp: 'Necessária apenas se o Moonraker exigir autenticação para este host.',
      klipperModelPlaceholder: 'p. ex. Voron 2.4 350',
      importHistory: 'Histórico de impressões',
      importHistoryButton: 'Importar do Moonraker',
      importHistoryHelp: 'Adiciona ao arquivo cada impressão que o Moonraker registrou, sem os arquivos. Impressões já importadas são ignoradas, então pode repetir sem problema.',
    ...
    discovery: {
      ...
      scanKlipper: 'Procurar impressoras Klipper na rede',
    ...
    firmwareSystemPackages_one: 'sistema: {{count}} atualização de pacote',
    firmwareSystemPackages_other: 'sistema: {{count}} atualizações de pacotes',
    ...
    printSource: {
      title: 'Escolha um arquivo para imprimir',
      hint: 'Imprimindo em {{printer}} — escolha um arquivo da sua biblioteca ou envie um novo',
  ...
  archives: {
    ...
    card: {
      ...
      priceTitle: 'Preço sugerido. Custo {{cost}}, margem {{margin}}.',
      priceFloor: 'mínimo',
      object: '{{count}} objeto',
  ...
  settings: {
    ...
    openFilamentDatabase: 'Buscar carretéis via Open Filament Database',
    openFilamentDatabaseDesc: 'Adiciona ao formulário de adicionar carretel uma busca que preenche marca, material, cor, peso e temperaturas a partir de openfilamentdatabase.org. Ao usá-la, o Bambuddy chama esse site pelo backend.',
    ...
    pricingEnabled: 'Preço de venda sugerido',
    pricingEnabledDescription: 'Mostra por quanto uma impressão arquivada deveria ser vendida, a partir do custo de filamento e energia. Separado do faturamento, que lança as impressões em um centro de custo.',
    pricingLabourPerHour: 'Mão de obra por hora de impressão',
    pricingMarkup: 'Multiplicador',
    pricingFloor: 'Preço mínimo',
    pricingReference: 'Uma impressão típica sua custa {{cost}} para produzir, com base em {{samples}} impressões dos últimos {{days}} dias.',
    pricingReferenceEmpty: 'Ainda não há impressões com custo, então não existe um custo típico para contrastar com um multiplicador.',
  ...
  printerFiles: {
    printOnPrinter: 'Iniciar na impressora',
    printStarted: 'Impressão iniciada na impressora',
    printFailed: 'Não foi possível iniciar a impressão: {{error}}',
  ...
  farm: {
    ...
    subtitle: 'Visão em tempo real da sua oficina de impressão',
    utilization: 'Utilização',
    tvMode: 'Modo TV',
    fleetStatus: 'Estado da frota',
    searchPrinters: 'Buscar impressoras...',
    groupFilter: 'Filtrar por grupo',
    allGroups: 'Todos os grupos',
    createGroup: 'Criar grupo',
    ungrouped: 'Sem grupo',
    noPrintersMatch: 'Nenhuma impressora corresponde aos filtros.',
    activeProjects: 'Projetos ativos',
    viewAllProjects: 'Ver todos os projetos',
    noActiveProjects: 'Nenhum projeto ativo sendo acompanhado.',
    totalCount: '{{count}} no total',
    onlineCount: '{{count}} online',
    offlineCount: '{{count}} offline',
    allOperational: 'Tudo funcionando',
    needAttention_one: '{{count}} item precisa de atenção',
    needAttention_other: '{{count}} itens precisam de atenção',
    noIssues: 'Nenhum problema ativo',
    openAlerts: 'Abrir a lista de alertas',
    filamentStock: 'Estoque de filamento',
    spoolsLow_one: '{{count}} carretel quase vazio',
    spoolsLow_other: '{{count}} carretéis quase vazios',
    maintenance: 'Manutenção',
    maintenanceDue_one: '{{count}} item de manutenção precisa de atenção',
    maintenanceDue_other: '{{count}} itens de manutenção precisam de atenção',
    state: {
      printing: 'Imprimindo',
      paused: 'Pausada',
      idle: 'Ociosa',
    ...
    stats: {
      ...
      paused: 'Pausadas',
      alerts: 'Alertas',
      partsToday: 'Peças hoje',
      ofFleet: '{{percent}}% da frota',
      alertsSub: 'Impressoras, estoque, manutenção',
      queueTracked_one: '{{count}} item na fila',
      queueTracked_other: '{{count}} itens na fila',
    },
    project: {
    ...
    alerts: {
      title: 'Alertas',
      subtitle: 'Impressoras, filamento e manutenção que precisam de atenção.',
      empty: 'Nada precisa de atenção agora.',
      printerError: 'A impressora reportou um erro',
      printerPaused: 'Pausada - pode precisar de ajuda',
      printerOffline: 'Offline ou inacessível',
      spoolLow: '{{percent}}% de filamento restante',
      maintenance: '{{item}}',
    },
    groups: {
      title: 'Grupos de impressoras',
      subtitle: 'Agrupe impressoras para organizá-las no centro de comando.',
      nameLabel: 'Nome do grupo',
      current: 'Grupos atuais',
      printerCount_one: '{{count}} impressora',
      printerCount_other: '{{count}} impressoras',
      save: 'Salvar grupo',
    },
  },
  projects: {
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: 'Escolha marca, material, filamento e cor para preencher este carretel. Todos os campos continuam editáveis.',
      brandLabel: 'Marca',
      brandPlaceholder: 'Buscar marcas na OFDB...',
      brandLoadFailed: 'Não foi possível carregar as marcas do Open Filament Database',
      noBrands: 'Nenhuma marca encontrada no Open Filament Database.',
      materialLabel: 'Material',
      materialLoadFailed: 'Não foi possível carregar os materiais desta marca',
      noMaterials: 'Esta marca não tem materiais listados.',
      filamentLabel: 'Filamento',
      filamentPlaceholder: 'Filtrar filamentos...',
      searchFailed: 'Não foi possível carregar os filamentos desta marca e material',
      noFilaments: 'Nenhum filamento listado para esta marca e material.',
      filamentLoadFailed: 'Não foi possível carregar os detalhes do filamento',
      noVariants: 'Este filamento não tem cores listadas.',
      variantLabel: 'Cor',
      variantLoadFailed: 'Não foi possível carregar os detalhes da cor',
      applied: 'Preenchido a partir do Open Filament Database. Confira os campos antes de salvar.',
      materialCount: '{{count}} material(is)',
      filamentCount: '{{count}} filamento(s)',
      variantCount: '{{count}} cor(es)',
    ...
    nextSlot: {
      action: 'Atribuir ao próximo slot do AMS carregado',
      badge: 'Próximo slot em {{printer}}',
      badgeTitle: 'Aguardando o próximo slot do AMS carregado. Expira às {{expires}}.',
      anyPrinter: 'qualquer impressora',
      cancel: 'Cancelar atribuição ao próximo slot',
      cancelled: 'Atribuição ao próximo slot cancelada',
      cancelError: 'Não foi possível cancelar a atribuição ao próximo slot',
      modalTitle: 'Atribuir ao próximo slot carregado',
      modalIntro: 'Carregue {{spool}} em um slot livre do AMS da impressora abaixo. No momento em que a impressora informar, o slot será atribuído a este carretel, incluindo os ajustes de filamento.',
      printerLabel: 'Impressora',
      timeoutLabel: 'Esperar no máximo',
      timeoutOptions: {
        m15: '15 minutos',
        m30: '30 minutos',
        h2: '2 horas',
      ...
      rfidNote: 'Um carretel da Bambu Lab cuja etiqueta RFID já pertence a outro carretel do inventário mantém esse registro; a solicitação então aguarda o próximo slot.',
      submit: 'Aguardar o próximo slot',
      submitting: 'Salvando...',
      created: 'Aguardando o próximo slot carregado em {{printer}}',
      createError: 'Não foi possível criar a atribuição ao próximo slot',
      completedToast: 'Carretel atribuído a {{printer}} {{slot}}',
      timedOutToast: 'Uma atribuição ao próximo slot expirou antes de um carretel ser carregado',
      fromSlotDialog: 'Próximo slot carregado em vez disso',
    },
  ...
  printModal: {
    ...
    jobNamePlaceholder: 'ex. Pedido 1234',
    jobNameHint: 'Dá nome ao arquivo enviado à impressora, para que a tela dela mostre isto em vez do nome do modelo.',
  ...
  smartPlugs: {
    ...
    moonrakerDevice: 'Dispositivo de energia',
    moonrakerDeviceHelp: 'Um dispositivo [power] do próprio Moonraker da impressora. Endereço e chave de API vêm da impressora, então alterá-los lá não quebra esta tomada.',
    moonrakerPickPrinter: 'Selecione primeiro uma impressora Klipper abaixo.',
    moonrakerSelectDevice: 'Selecione um dispositivo…',
    moonrakerNoDevices: 'O Moonraker desta impressora não tem dispositivos [power] configurados.',
    moonrakerDevicesFailed: 'Não foi possível ler os dispositivos de energia do Moonraker.',
    moonrakerPrinterRequired: 'Selecione uma impressora Klipper para este dispositivo',
    moonrakerDeviceRequired: 'Selecione um dispositivo de energia',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: 'Notificações push do iOS pelo app Notify, com um bloco ao vivo do progresso da impressão na Dynamic Island',
    },
    ...
    printAlmostDone: 'Quase pronta',
    printAlmostDoneDescription: 'Avisar aos 97% com uma foto da câmera, para tirar as peças assim que a impressão terminar',
    printerOffline: 'Impressora Offline',
    ...
    printAlmostDoneHint: '(97%, com foto da câmera)',
