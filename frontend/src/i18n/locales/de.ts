export default {
  ...
  printers: {
    ...
    tv: {
      title: 'Druckfarm',
      backToApp: 'Zurück zu Bambuddy',
      tokenRejected: 'Dieser TV-Link ist nicht mehr gültig. Das Token ist abgelaufen oder wurde widerrufen.',
      refreshInterval: 'Aktualisierung',
      everySeconds: 'alle {{seconds}}s',
      cameras: 'Kameras',
      total: '{{count}} Drucker',
      currentJob: 'Aktueller Auftrag',
      unnamedJob: 'Aktiver Druck',
      progress: 'Druckfortschritt',
      eta: 'Fertig {{time}}',
      idleHint: {
        idle: 'Bereit zum Drucken',
        finished: 'Druck fertig, Bett noch nicht geräumt',
    ...
    toast: {
      ...
      historyImported_one: '{{count}} Druck importiert',
      historyImported_other: '{{count}} Drucke importiert',
      historyNothingNew: 'Keine neuen Drucke zum Importieren',
      historyImportFailed: 'Druckverlauf konnte nicht importiert werden',
    ...
    modal: {
      ...
      chamberObject: 'Kammersensor',
      chamberObjectAuto: 'Automatisch',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: 'Welches Klipper-Objekt die Kammer meldet. Automatisch sucht nach einem Objekt namens chamber; wählen Sie Ihres, wenn es anders heißt.',
      chamberObjectUsing: 'Automatisch gefunden: {{name}}.',
      transport: 'Statusaktualisierung',
      transportAuto: 'Push, mit Abfrage als Reserve',
      transportPoll: 'Nur Abfrage',
      transportHelp: 'Push-Aktualisierungen kommen über den WebSocket von Moonraker und erreichen die Karte in deutlich unter einer Sekunde. Abgefragt wird ohnehin weiterhin; wählen Sie nur Abfrage, wenn etwas zwischen Bambuddy und dem Drucker WebSocket-Verbindungen ablehnt.',
      ...
      importHistory: 'Druckverlauf',
      importHistoryButton: 'Aus Moonraker importieren',
      importHistoryHelp: 'Übernimmt jeden Druck, den Moonraker gespeichert hat, ins Archiv — ohne Dateien. Bereits importierte Drucke werden übersprungen, ein erneuter Lauf ist also unbedenklich.',
    ...
    discovery: {
      ...
      scanKlipper: 'Netzwerk nach Klipper-Druckern durchsuchen',
    ...
    firmwareSystemPackages_one: 'System: {{count}} Paketupdate',
    firmwareSystemPackages_other: 'System: {{count}} Paketupdates',
    ...
    printSource: {
      title: 'Datei zum Drucken auswählen',
      hint: 'Druck auf {{printer}} — wähle eine Datei aus deiner Bibliothek oder lade eine neue hoch',
  ...
  archives: {
    ...
    card: {
      ...
      priceTitle: 'Vorgeschlagener Preis. Kosten {{cost}}, Marge {{margin}}.',
      priceFloor: 'Mindestpreis',
      object: '{{count}} Objekt',
  ...
  settings: {
    ...
    openFilamentDatabase: 'Spulen über Open Filament Database suchen',
    openFilamentDatabaseDesc: 'Ergänzt das Formular zum Hinzufügen einer Spule um eine Suche, die Marke, Material, Farbe, Gewicht und Temperaturen von openfilamentdatabase.org vorausfüllt. Bambuddy ruft die Seite dabei vom Backend aus auf.',
    ...
    pricingEnabled: 'Vorgeschlagener Verkaufspreis',
    pricingEnabledDescription: 'Zeigt, wofür ein archivierter Druck verkauft werden sollte, berechnet aus Filament- und Energiekosten. Unabhängig von der Abrechnung, die Drucke einer Kostenstelle belastet.',
    pricingLabourPerHour: 'Arbeitszeit pro Druckstunde',
    pricingMarkup: 'Aufschlag',
    pricingFloor: 'Mindestpreis',
    pricingReference: 'Ein typischer Druck von Ihnen kostet {{cost}} in der Herstellung, über {{samples}} Drucke der letzten {{days}} Tage.',
    pricingReferenceEmpty: 'Noch keine bepreisten Drucke, also gibt es keine typischen Kosten, gegen die sich ein Aufschlag halten ließe.',
  ...
  farm: {
    title: 'Farm-Kommandozentrale',
    subtitle: 'Echtzeitüberblick über deinen Druckbetrieb',
    utilization: 'Auslastung',
    tvMode: 'TV-Modus',
    fleetStatus: 'Flottenstatus',
    searchPrinters: 'Drucker suchen...',
    groupFilter: 'Nach Gruppe filtern',
    allGroups: 'Alle Gruppen',
    createGroup: 'Gruppe erstellen',
    ungrouped: 'Ohne Gruppe',
    noPrintersMatch: 'Keine Drucker entsprechen den Filtern.',
    activeProjects: 'Aktive Projekte',
    viewAllProjects: 'Alle Projekte',
    noActiveProjects: 'Derzeit werden keine aktiven Projekte verfolgt.',
    totalCount: '{{count}} gesamt',
    onlineCount: '{{count}} online',
    offlineCount: '{{count}} offline',
    allOperational: 'Alles läuft',
    needAttention_one: '{{count}} Punkt braucht Aufmerksamkeit',
    needAttention_other: '{{count}} Punkte brauchen Aufmerksamkeit',
    noIssues: 'Keine offenen Probleme',
    openAlerts: 'Meldungsliste öffnen',
    filamentStock: 'Filamentbestand',
    spoolsLow_one: '{{count}} Spule fast leer',
    spoolsLow_other: '{{count}} Spulen fast leer',
    maintenance: 'Wartung',
    maintenanceDue_one: '{{count}} Wartungspunkt braucht Aufmerksamkeit',
    maintenanceDue_other: '{{count}} Wartungspunkte brauchen Aufmerksamkeit',
    state: {
      printing: 'Druckt',
      paused: 'Pausiert',
      idle: 'Bereit',
    ...
    stats: {
      ...
      paused: 'Pausiert',
      alerts: 'Meldungen',
      partsToday: 'Teile heute',
      ofFleet: '{{percent}}% der Flotte',
      alertsSub: 'Drucker, Bestand, Wartung',
      queueTracked_one: '{{count}} Auftrag in der Warteschlange',
      queueTracked_other: '{{count}} Aufträge in der Warteschlange',
    },
    project: {
    ...
    alerts: {
      title: 'Meldungen',
      subtitle: 'Drucker, Filament und Wartung, die Aufmerksamkeit brauchen.',
      empty: 'Derzeit braucht nichts Aufmerksamkeit.',
      printerError: 'Drucker meldet eine Störung',
      printerPaused: 'Pausiert - braucht eventuell Hilfe',
      printerOffline: 'Offline oder nicht erreichbar',
      spoolLow: '{{percent}}% Filament übrig',
      maintenance: '{{item}}',
    },
    groups: {
      title: 'Druckergruppen',
      subtitle: 'Drucker gruppieren, um sie in der Kommandozentrale zu bündeln.',
      nameLabel: 'Gruppenname',
      current: 'Aktuelle Gruppen',
      printerCount_one: '{{count}} Drucker',
      printerCount_other: '{{count}} Drucker',
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: 'Wählen Sie Marke, Material, Filament und Farbe, um diese Spule vorauszufüllen. Alle Felder bleiben bearbeitbar.',
      brandLabel: 'Marke',
      brandPlaceholder: 'OFDB-Marken durchsuchen...',
      brandLoadFailed: 'Marken konnten nicht aus der Open Filament Database geladen werden',
      noBrands: 'Keine Marken in der Open Filament Database gefunden.',
      materialLabel: 'Material',
      materialLoadFailed: 'Die Materialien dieser Marke konnten nicht geladen werden',
      noMaterials: 'Für diese Marke sind keine Materialien hinterlegt.',
      filamentLabel: 'Filament',
      filamentPlaceholder: 'Filamente filtern...',
      searchFailed: 'Die Filamente für diese Marke und dieses Material konnten nicht geladen werden',
      noFilaments: 'Für diese Marke und dieses Material sind keine Filamente hinterlegt.',
      filamentLoadFailed: 'Die Filamentdetails konnten nicht geladen werden',
      noVariants: 'Für dieses Filament sind keine Farben hinterlegt.',
      variantLabel: 'Farbe',
      variantLoadFailed: 'Die Farbdetails konnten nicht geladen werden',
      applied: 'Aus der Open Filament Database vorausgefüllt. Prüfen Sie die Felder vor dem Speichern.',
      materialCount: '{{count}} Material(ien)',
      filamentCount: '{{count}} Filament(e)',
      variantCount: '{{count}} Farbe(n)',
    ...
    nextSlot: {
      action: 'Dem nächsten geladenen AMS-Slot zuweisen',
      badge: 'Nächster Slot an {{printer}}',
      badgeTitle: 'Warten auf den nächsten geladenen AMS-Slot. Läuft ab um {{expires}}.',
      anyPrinter: 'beliebiger Drucker',
      cancel: 'Zuweisung an den nächsten Slot abbrechen',
      cancelled: 'Zuweisung an den nächsten Slot abgebrochen',
      cancelError: 'Die Zuweisung an den nächsten Slot konnte nicht abgebrochen werden',
      modalTitle: 'Dem nächsten geladenen Slot zuweisen',
      modalIntro: 'Legen Sie {{spool}} in einen freien AMS-Slot des unten gewählten Druckers ein. Sobald der Drucker das meldet, wird der Slot dieser Spule zugewiesen, samt Filamenteinstellungen.',
      printerLabel: 'Drucker',
      timeoutLabel: 'Höchstens warten',
      timeoutOptions: {
        m15: '15 Minuten',
        m30: '30 Minuten',
        h2: '2 Stunden',
      ...
      rfidNote: 'Eine Bambu-Lab-Spule, deren RFID-Tag bereits zu einer anderen Spule im Bestand gehört, behält diesen Eintrag; die Anfrage wartet dann auf den nächsten Slot.',
      submit: 'Auf nächsten Slot warten',
      submitting: 'Wird gespeichert...',
      created: 'Warten auf den nächsten geladenen Slot an {{printer}}',
      createError: 'Die Zuweisung an den nächsten Slot konnte nicht erstellt werden',
      completedToast: 'Spule {{printer}} {{slot}} zugewiesen',
      timedOutToast: 'Eine Zuweisung an den nächsten Slot ist abgelaufen, bevor eine Spule geladen wurde',
      fromSlotDialog: 'Stattdessen nächster geladener Slot',
    },
  ...
  printModal: {
    ...
    jobNamePlaceholder: 'z. B. Bestellung 1234',
    jobNameHint: 'Benennt die an den Drucker gesendete Datei, sodass dessen Display dies statt des Modellnamens zeigt.',
  ...
  smartPlugs: {
    ...
    moonrakerDevice: 'Stromgerät',
    moonrakerDeviceHelp: 'Ein [power]-Gerät aus dem Moonraker des Druckers. Adresse und API-Schlüssel kommen vom Drucker — wer die dort ändert, behält diese Steckdose.',
    moonrakerPickPrinter: 'Wähle unten zuerst einen Klipper-Drucker.',
    moonrakerSelectDevice: 'Gerät auswählen…',
    moonrakerNoDevices: 'Im Moonraker dieses Druckers sind keine [power]-Geräte konfiguriert.',
    moonrakerDevicesFailed: 'Stromgeräte konnten nicht aus Moonraker gelesen werden.',
    moonrakerPrinterRequired: 'Wähle einen Klipper-Drucker für dieses Stromgerät',
    moonrakerDeviceRequired: 'Wähle ein Stromgerät',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: 'iOS-Push-Benachrichtigungen über die App Notify, mit einer Live-Kachel zum Druckfortschritt in der Dynamic Island',
    },
    ...
    printAlmostDone: 'Fast fertig',
    printAlmostDoneDescription: 'Benachrichtigung bei 97 % mit Kamerabild, damit die Teile direkt nach dem Druckende abgenommen werden können',
    printerOffline: 'Drucker offline',
    printerError: 'Druckerfehler',
    ...
    printAlmostDoneHint: '(97 %, mit Kamerabild)',
