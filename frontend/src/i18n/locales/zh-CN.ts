export default {
  // Voron patch series (B5)：“需要处理”提示条
  alerts: {
    title: '需要处理',
    maintenanceDue_one: '{{count}} 项维护待办',
    maintenanceDue_other: '{{count}} 项维护待办',
    lowStock_one: '{{count}} 卷料快用完',
    lowStock_other: '{{count}} 卷料快用完',
    printerFaults_one: '{{count}} 台打印机报错',
    printerFaults_other: '{{count}} 台打印机报错',
    more: '还有 {{count}} 项',
  ...
  printers: {
    ...
    toast: {
      ...
      historyImported_one: '已导入 {{count}} 条打印记录',
      historyImported_other: '已导入 {{count}} 条打印记录',
      historyNothingNew: '没有可导入的新打印记录',
      historyImportFailed: '无法导入打印历史',
    ...
    // Connection status
    connection: {
      klippyShutdown: 'Klipper 已关闭',
      klippyError: 'Klipper 错误',
      klippyStartup: 'Klipper 启动中',
      klippyDisconnected: 'Klipper 未运行',
      connected: '已连接',
      offline: '离线',
    },
    plateStatus: {
    ...
    modal: {
      ...
      chamberObject: '腔体传感器',
      chamberObjectAuto: '自动',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: '由哪个 Klipper 对象报告腔体温度。自动模式会查找名为 chamber 的对象；若你的名称不同，请手动选择。',
      chamberObjectUsing: '自动找到了 {{name}}。',
      transport: '状态更新',
      transportAuto: '推送，并保留轮询作为后备',
      transportPoll: '仅轮询',
      transportHelp: '推送更新经由 Moonraker 的 WebSocket 送达，不到一秒即可反映到卡片上。无论哪种方式轮询都会继续；只有当 Bambuddy 与打印机之间有设备拒绝 WebSocket 连接时，才选择仅轮询。',
      moonrakerApiKeyHelp: '仅当 Moonraker 对该主机要求认证时才需要。',
      klipperModelPlaceholder: '例如 Voron 2.4 350',
      importHistory: '打印历史',
      importHistoryButton: '从 Moonraker 导入',
      importHistoryHelp: '把 Moonraker 记录的每个任务加入归档（不含文件）。已导入的任务会被跳过，可以放心重复运行。',
      saveChanges: '保存更改',
    },
    // Skip objects
    skipObjects: {
    ...
    discovery: {
      ...
      scanKlipper: '在网络中扫描 Klipper 打印机',
    ...
    printSource: {
      title: '选择要打印的文件',
      hint: '在 {{printer}} 上打印 — 从文件库中选择文件，或上传新文件',
      empty: '文件库中还没有已切片的文件',
      noMatches: '没有匹配的文件',
      uploadInstead: '上传文件',
  ...
  archives: {
    ...
    card: {
      ...
      layer: '{{count}} 层',
      layers: '{{count}} 层',
      priceTitle: '建议价格。成本 {{cost}}，毛利率 {{margin}}。',
      priceFloor: '下限',
      object: '{{count}} 个对象',
      objects: '{{count}} 个对象',
  ...
  settings: {
    ...
    openFilamentDatabase: '通过 Open Filament Database 搜索线轴',
    openFilamentDatabaseDesc: '在添加线轴表单中加入查询功能，可从 openfilamentdatabase.org 预填品牌、材料、颜色、重量和温度。使用时，Bambuddy 会从后端访问该网站。',
    ...
    pricingEnabled: '建议售价',
    pricingEnabledDescription: '根据线材和电费成本，显示归档打印应当卖多少钱。与把打印计入成本中心的计费功能相互独立。',
    pricingLabourPerHour: '每打印小时人工费',
    pricingMarkup: '倍率',
    pricingFloor: '最低价格',
    pricingReference: '按最近 {{days}} 天的 {{samples}} 次打印计算，你一次典型打印的制作成本为 {{cost}}。',
    pricingReferenceEmpty: '尚无带成本的打印记录，因此没有可用来衡量倍率的典型成本。',
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: '选择品牌、材料、线材和颜色以预填此线轴。所有字段仍可编辑。',
      brandLabel: '品牌',
      brandPlaceholder: '搜索 OFDB 品牌...',
      brandLoadFailed: '无法从 Open Filament Database 加载品牌',
      noBrands: '在 Open Filament Database 中未找到品牌。',
      materialLabel: '材料',
      materialLoadFailed: '无法加载该品牌的材料',
      noMaterials: '该品牌未列出任何材料。',
      filamentLabel: '线材',
      filamentPlaceholder: '筛选线材...',
      searchFailed: '无法加载该品牌和材料的线材',
      noFilaments: '该品牌和材料下未列出线材。',
      filamentLoadFailed: '无法加载线材详情',
      noVariants: '该线材未列出任何颜色。',
      variantLabel: '颜色',
      variantLoadFailed: '无法加载颜色详情',
      applied: '已从 Open Filament Database 预填。保存前请检查各字段。',
      materialCount: '{{count}} 种材料',
      filamentCount: '{{count}} 种线材',
      variantCount: '{{count}} 种颜色',
      sizeCount: '{{count}} 种规格',
    },
    addSpool: '添加耗材',
    editSpool: '编辑耗材',
    ...
    nextSlot: {
      action: '分配到下一个装载的 AMS 槽位',
      badge: '{{printer}} 上的下一个槽位',
      badgeTitle: '正在等待下一个装载的 AMS 槽位。将于 {{expires}} 过期。',
      anyPrinter: '任意打印机',
      cancel: '取消下一槽位分配',
      cancelled: '已取消下一槽位分配',
      cancelError: '无法取消下一槽位分配',
      modalTitle: '分配到下一个装载的槽位',
      modalIntro: '请将 {{spool}} 装入下方打印机的空闲 AMS 槽位。打印机一旦上报，该槽位便会分配给此线轴，并同步线材设置。',
      printerLabel: '打印机',
      timeoutLabel: '最长等待',
      timeoutOptions: {
        m15: '15 分钟',
      ...
      rfidNote: 'RFID 标签已属于库存中另一线轴的 Bambu Lab 线轴会保留原有记录；此请求随后继续等待下一个槽位。',
      submit: '等待下一个槽位',
      submitting: '正在保存...',
      created: '正在等待 {{printer}} 上下一个装载的槽位',
      createError: '无法创建下一槽位分配',
      completedToast: '线轴已分配到 {{printer}} {{slot}}',
      timedOutToast: '一项下一槽位分配在装入线轴前已过期',
      fromSlotDialog: '改为下一个装载的槽位',
    },
  ...
  printModal: {
    ...
    jobName: '作业名称',
    jobNamePlaceholder: '例如：订单 1234',
    jobNameHint: '为发送到打印机的文件命名，使打印机屏幕显示它而不是模型名称。',
  ...
  smartPlugs: {
    ...
    moonrakerDevice: '电源设备',
    moonrakerDeviceHelp: '来自打印机自身 Moonraker 的 [power] 设备。地址和 API 密钥取自打印机，因此在那里修改不会影响这个插座。',
    moonrakerPickPrinter: '请先在下方选择一台 Klipper 打印机。',
    moonrakerSelectDevice: '选择设备…',
    moonrakerNoDevices: '这台打印机的 Moonraker 未配置任何 [power] 设备。',
    moonrakerDevicesFailed: '无法从 Moonraker 读取电源设备。',
    moonrakerPrinterRequired: '请为该电源设备选择一台 Klipper 打印机',
    moonrakerDeviceRequired: '请选择一个电源设备',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: '通过 Notify 应用推送 iOS 通知，并在灵动岛显示实时打印进度磁贴',
    },
    ...
    printAlmostDone: '即将完成',
    printAlmostDoneDescription: '在 97% 时发送带摄像头快照的通知，以便打印一结束就取下零件',
    printerOffline: '打印机离线',
    printerError: '打印机错误',
  ...
  cameraTokens: {
    ...
    create: {
      ...
      hintTv:
        '电视令牌可在无需登录的屏幕上打开 /tv——墙上的显示器、看板模式下的树莓派。它能看到每台打印机的状态、正在打印的文件、进度和已装载的料盘，以及它们的摄像头快照。它看不到地址或访问码。',
      title: '创建新令牌',
      nameLabel: '令牌名称',
    ...
    created: {
      ...
      tvUrlTitle: '此屏幕的电视链接',
      tvUrlHint:
        '在屏幕上打开此链接。加上 &cams=0 可隐藏摄像头画面，加上 &refresh=10 可更改刷新频率。任何能读到该链接的人都能看到这面墙，因此请把它当作钥匙——撤销令牌即可切断显示。',
      title: '令牌已创建 — 立即复制',
      warning:
