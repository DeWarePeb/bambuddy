export default {
  ...
  printers: {
    ...
    // Chamber light
    console: {
      title: 'Macros y consola',
      searchMacros: 'Buscar macros',
      noMacros: 'Esta impresora no define macros',
      emptyLog: 'Todavía no hay nada en el registro de la impresora',
      placeholder: 'Escribe un comando G-code',
      send: 'Enviar',
      printingWarning: 'Hay una impresión en curso. Lo que envíes desde aquí llega en mitad del trabajo: marca para enviarlo igualmente.',
      confirmRequired: 'Hay una impresión en curso: confirma arriba para enviar igualmente',
      sendFailed: 'La impresora rechazó ese comando: {{error}}',
      unavailable: 'No se pudo contactar con la impresora',
    },
    ...
    toast: {
      ...
      historyImported_one: '{{count}} impresión importada',
      historyImported_other: '{{count}} impresiones importadas',
      historyNothingNew: 'No hay impresiones nuevas que importar',
      historyImportFailed: 'No se pudo importar el historial de impresiones',
    ...
    modal: {
      ...
      providerLabel: 'Tipo de impresora',
      providerBambu: 'Bambu Lab',
      providerKlipper: 'Klipper (Moonraker)',
      moonrakerUrl: 'URL de Moonraker',
      moonrakerUrlHelp: 'La dirección de Mainsail o Fluidd, p. ej. http://voron.local o http://192.168.1.50. El número de serie y la IP se derivan de ella.',
      moonrakerApiKey: 'Clave API de Moonraker (opcional)',
      chamberObject: 'Sensor de la cámara',
      chamberObjectAuto: 'Automático',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: 'Qué objeto de Klipper informa de la cámara. El modo automático busca uno llamado chamber; elija el suyo si tiene otro nombre.',
      chamberObjectUsing: 'El modo automático encontró {{name}}.',
      transport: 'Actualizaciones de estado',
      transportAuto: 'Push, con sondeo de reserva',
      transportPoll: 'Solo sondeo',
      transportHelp: 'Las actualizaciones push llegan por el WebSocket de Moonraker y alcanzan la tarjeta en bastante menos de un segundo. El sondeo continúa en cualquier caso; elija solo sondeo si algo entre Bambuddy y la impresora rechaza las conexiones WebSocket.',
      moonrakerApiKeyHelp: 'Solo es necesaria si Moonraker exige autenticación para este host.',
      klipperModelPlaceholder: 'p. ej. Voron 2.4 350',
      importHistory: 'Historial de impresiones',
      importHistoryButton: 'Importar desde Moonraker',
      importHistoryHelp: 'Añade al archivo cada impresión que Moonraker recuerda, sin archivos. Las impresiones ya importadas se omiten, así que puedes repetirlo sin problema.',
    ...
    discovery: {
      ...
      scanKlipper: 'Buscar impresoras Klipper en la red',
    ...
    printSource: {
      title: 'Elige un archivo para imprimir',
      hint: 'Imprimiendo en {{printer}} — elige un archivo de tu biblioteca o sube uno nuevo',
  ...
  archives: {
    ...
    card: {
      ...
      layer: '{{count}} capa',
      layers: '{{count}} capas',
      priceTitle: 'Precio sugerido. Coste {{cost}}, margen {{margin}}.',
      priceFloor: 'mínimo',
      object: '{{count}} objeto',
  ...
  settings: {
    ...
    openFilamentDatabase: 'Buscar bobinas en Open Filament Database',
    openFilamentDatabaseDesc: 'Añade al formulario de añadir bobina una búsqueda que rellena marca, material, color, peso y temperaturas desde openfilamentdatabase.org. Al usarla, Bambuddy consulta ese sitio desde el backend.',
    ...
    pricingEnabled: 'Precio de venta sugerido',
    pricingEnabledDescription: 'Muestra por cuánto debería venderse una impresión archivada, a partir de su coste de filamento y energía. Independiente de la facturación, que carga las impresiones a un centro de coste.',
    pricingLabourPerHour: 'Mano de obra por hora de impresión',
    pricingMarkup: 'Multiplicador',
    pricingFloor: 'Precio mínimo',
    pricingReference: 'Una impresión típica suya cuesta {{cost}} de fabricar, sobre {{samples}} impresiones de los últimos {{days}} días.',
    pricingReferenceEmpty: 'Todavía no hay impresiones con coste, así que no hay un coste típico con el que contrastar un multiplicador.',
  ...
  printerFiles: {
    printOnPrinter: 'Iniciar en la impresora',
    printStarted: 'Impresión iniciada en la impresora',
    printFailed: 'No se pudo iniciar la impresión: {{error}}',
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: 'Elija marca, material, filamento y color para rellenar esta bobina. Todos los campos siguen siendo editables.',
      brandLabel: 'Marca',
      brandPlaceholder: 'Buscar marcas en OFDB...',
      brandLoadFailed: 'No se pudieron cargar las marcas de Open Filament Database',
      noBrands: 'No se han encontrado marcas en Open Filament Database.',
      materialLabel: 'Material',
      materialLoadFailed: 'No se pudieron cargar los materiales de esta marca',
      noMaterials: 'Esta marca no tiene materiales listados.',
      filamentLabel: 'Filamento',
      filamentPlaceholder: 'Filtrar filamentos...',
      searchFailed: 'No se pudieron cargar los filamentos de esta marca y material',
      noFilaments: 'No hay filamentos listados para esta marca y material.',
      filamentLoadFailed: 'No se pudieron cargar los detalles del filamento',
      noVariants: 'Este filamento no tiene colores listados.',
      variantLabel: 'Color',
      variantLoadFailed: 'No se pudieron cargar los detalles del color',
      applied: 'Rellenado desde Open Filament Database. Revise los campos antes de guardar.',
      materialCount: '{{count}} material(es)',
      filamentCount: '{{count}} filamento(s)',
      variantCount: '{{count}} color(es)',
    ...
    nextSlot: {
      action: 'Asignar a la próxima ranura AMS cargada',
      badge: 'Próxima ranura en {{printer}}',
      badgeTitle: 'Esperando la próxima ranura AMS cargada. Caduca a las {{expires}}.',
      anyPrinter: 'cualquier impresora',
      cancel: 'Cancelar la asignación a la próxima ranura',
      cancelled: 'Asignación a la próxima ranura cancelada',
      cancelError: 'No se pudo cancelar la asignación a la próxima ranura',
      modalTitle: 'Asignar a la próxima ranura cargada',
      modalIntro: 'Cargue {{spool}} en una ranura AMS libre de la impresora indicada abajo. En cuanto la impresora lo comunique, la ranura se asignará a esta bobina, incluidos los ajustes de filamento.',
      printerLabel: 'Impresora',
      timeoutLabel: 'Esperar como máximo',
      timeoutOptions: {
        m15: '15 minutos',
        m30: '30 minutos',
        h2: '2 horas',
      ...
      rfidNote: 'Una bobina de Bambu Lab cuya etiqueta RFID ya pertenece a otra bobina del inventario conserva esa entrada; la solicitud espera entonces a la próxima ranura.',
      submit: 'Esperar a la próxima ranura',
      submitting: 'Guardando...',
      created: 'Esperando la próxima ranura cargada en {{printer}}',
      createError: 'No se pudo crear la asignación a la próxima ranura',
      completedToast: 'Bobina asignada a {{printer}} {{slot}}',
      timedOutToast: 'Una asignación a la próxima ranura caducó antes de que se cargara una bobina',
      fromSlotDialog: 'Próxima ranura cargada en su lugar',
    },
  ...
  printModal: {
    ...
    jobNamePlaceholder: 'p. ej. Pedido 1234',
    jobNameHint: 'Nombra el archivo enviado a la impresora, para que su pantalla muestre esto en lugar del nombre del modelo.',
  ...
  smartPlugs: {
    ...
    moonrakerDevice: 'Dispositivo de alimentación',
    moonrakerDeviceHelp: 'Un dispositivo [power] del propio Moonraker de la impresora. La dirección y la clave API vienen de la impresora, así que cambiarlas allí no rompe este enchufe.',
    moonrakerPickPrinter: 'Selecciona primero una impresora Klipper abajo.',
    moonrakerSelectDevice: 'Selecciona un dispositivo…',
    moonrakerNoDevices: 'El Moonraker de esta impresora no tiene dispositivos [power] configurados.',
    moonrakerDevicesFailed: 'No se pudieron leer los dispositivos de alimentación desde Moonraker.',
    moonrakerPrinterRequired: 'Selecciona una impresora Klipper para este dispositivo',
    moonrakerDeviceRequired: 'Selecciona un dispositivo de alimentación',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: 'Notificaciones push de iOS mediante la app Notify, con un mosaico en vivo del progreso de impresión en la Dynamic Island',
    },
    ...
    printAlmostDone: 'Casi terminada',
    printAlmostDoneDescription: 'Avisar al 97 % con una captura de la cámara, para poder retirar las piezas en cuanto acabe la impresión',
    printerOffline: 'Impresora desconectada',
    printerError: 'Error de la impresora',
    ...
    printAlmostDoneHint: '(97 %, con captura de cámara)',
