export default {
  ...
  printers: {
    ...
    toast: {
      ...
      historyImported_one: '已匯入 {{count}} 筆列印紀錄',
      historyImported_other: '已匯入 {{count}} 筆列印紀錄',
      historyNothingNew: '沒有可匯入的新列印紀錄',
      historyImportFailed: '無法匯入列印歷史',
    ...
    modal: {
      ...
      moonrakerUrl: 'Moonraker 位址',
      moonrakerUrlHelp: 'Mainsail 或 Fluidd 的位址，例如 http://voron.local 或 http://192.168.1.50。序號與 IP 由此推導。',
      moonrakerApiKey: 'Moonraker API 金鑰（選填）',
      chamberObject: '腔體感測器',
      chamberObjectAuto: '自動',
      chamberObjectPlaceholder: 'temperature_sensor chamber',
      chamberObjectHelp: '由哪個 Klipper 物件回報腔體溫度。自動模式會尋找名為 chamber 的物件；若你的名稱不同，請手動選擇。',
      chamberObjectUsing: '自動找到了 {{name}}。',
      transport: '狀態更新',
      transportAuto: '推送，並保留輪詢作為後備',
      transportPoll: '僅輪詢',
      transportHelp: '推送更新經由 Moonraker 的 WebSocket 送達，不到一秒即可反映到卡片上。無論哪種方式輪詢都會繼續；只有當 Bambuddy 與印表機之間有裝置拒絕 WebSocket 連線時，才選擇僅輪詢。',
      moonrakerApiKeyHelp: '僅當 Moonraker 對此主機要求驗證時才需要。',
      klipperModelPlaceholder: '例如 Voron 2.4 350',
      importHistory: '列印歷史',
      importHistoryButton: '從 Moonraker 匯入',
      importHistoryHelp: '把 Moonraker 記錄的每個工作加入封存（不含檔案）。已匯入的工作會略過，可以放心重複執行。',
      saveChanges: '儲存更改',
    },
    // Skip objects
    skipObjects: {
    ...
    discovery: {
      ...
      scanKlipper: '在網路中掃描 Klipper 印表機',
    ...
    firmwareSystemPackages_one: '系統：{{count}} 個套件更新',
    firmwareSystemPackages_other: '系統：{{count}} 個套件更新',
  ...
  archives: {
    ...
    card: {
      ...
      layer: '{{count}} 層',
      layers: '{{count}} 層',
      priceTitle: '建議價格。成本 {{cost}}，毛利率 {{margin}}。',
      priceFloor: '下限',
      object: '{{count}} 個物件',
      objects: '{{count}} 個物件',
  ...
  settings: {
    ...
    openFilamentDatabase: '透過 Open Filament Database 搜尋料盤',
    openFilamentDatabaseDesc: '在新增料盤表單中加入查詢功能，可從 openfilamentdatabase.org 預先填入品牌、材料、顏色、重量與溫度。使用時，Bambuddy 會從後端存取該網站。',
    ...
    pricingEnabled: '建議售價',
    pricingEnabledDescription: '根據線材與電費成本，顯示封存的列印應該賣多少錢。與把列印計入成本中心的計費功能各自獨立。',
    pricingLabourPerHour: '每列印小時人工費',
    pricingMarkup: '倍率',
    pricingFloor: '最低價格',
    pricingReference: '依最近 {{days}} 天的 {{samples}} 次列印計算，你一次典型列印的製作成本為 {{cost}}。',
    pricingReferenceEmpty: '尚無帶成本的列印紀錄，因此沒有可用來衡量倍率的典型成本。',
  ...
  printerFiles: {
    printOnPrinter: '在印表機上開始',
    printStarted: '已在印表機上開始列印',
    printFailed: '無法開始列印：{{error}}',
  ...
  inventory: {
    ...
    openFilamentDatabase: {
      ...
      hint: '選擇品牌、材料、線材與顏色以預先填入此料盤。所有欄位仍可編輯。',
      brandLabel: '品牌',
      brandPlaceholder: '搜尋 OFDB 品牌...',
      brandLoadFailed: '無法從 Open Filament Database 載入品牌',
      noBrands: '在 Open Filament Database 中找不到品牌。',
      materialLabel: '材料',
      materialLoadFailed: '無法載入此品牌的材料',
      noMaterials: '此品牌未列出任何材料。',
      filamentLabel: '線材',
      filamentPlaceholder: '篩選線材...',
      searchFailed: '無法載入此品牌與材料的線材',
      noFilaments: '此品牌與材料下未列出線材。',
      filamentLoadFailed: '無法載入線材詳細資料',
      noVariants: '此線材未列出任何顏色。',
      variantLabel: '顏色',
      variantLoadFailed: '無法載入顏色詳細資料',
      applied: '已從 Open Filament Database 預先填入。儲存前請檢查各欄位。',
      materialCount: '{{count}} 種材料',
      filamentCount: '{{count}} 種線材',
      variantCount: '{{count}} 種顏色',
      sizeCount: '{{count}} 種規格',
    },
    addSpool: '新增耗材',
    editSpool: '編輯耗材',
    ...
    nextSlot: {
      action: '指派給下一個裝載的 AMS 槽位',
      badge: '{{printer}} 上的下一個槽位',
      badgeTitle: '正在等待下一個裝載的 AMS 槽位。將於 {{expires}} 到期。',
      anyPrinter: '任一印表機',
      cancel: '取消下一槽位指派',
      cancelled: '已取消下一槽位指派',
      cancelError: '無法取消下一槽位指派',
      modalTitle: '指派給下一個裝載的槽位',
      modalIntro: '請將 {{spool}} 裝入下方印表機的空閒 AMS 槽位。印表機一旦回報，該槽位便會指派給此料盤，並套用線材設定。',
      printerLabel: '印表機',
      timeoutLabel: '最長等待',
      timeoutOptions: {
        m15: '15 分鐘',
      ...
      rfidNote: 'RFID 標籤已屬於庫存中其他料盤的 Bambu Lab 料盤會保留原有紀錄；此請求隨後繼續等待下一個槽位。',
      submit: '等待下一個槽位',
      submitting: '正在儲存...',
      created: '正在等待 {{printer}} 上下一個裝載的槽位',
      createError: '無法建立下一槽位指派',
      completedToast: '料盤已指派至 {{printer}} {{slot}}',
      timedOutToast: '一項下一槽位指派在裝入料盤前已到期',
      fromSlotDialog: '改為下一個裝載的槽位',
    },
  ...
  printModal: {
    ...
    jobName: '工作名稱',
    jobNamePlaceholder: '例如：訂單 1234',
    jobNameHint: '為傳送到印表機的檔案命名，使印表機螢幕顯示它而不是模型名稱。',
  ...
  smartPlugs: {
    ...
    moonrakerDevice: '電源裝置',
    moonrakerDeviceHelp: '來自印表機本身 Moonraker 的 [power] 裝置。位址與 API 金鑰取自印表機，因此在那裡修改不會影響這個插座。',
    moonrakerPickPrinter: '請先在下方選擇一台 Klipper 印表機。',
    moonrakerSelectDevice: '選擇裝置…',
    moonrakerNoDevices: '這台印表機的 Moonraker 未設定任何 [power] 裝置。',
    moonrakerDevicesFailed: '無法從 Moonraker 讀取電源裝置。',
    moonrakerPrinterRequired: '請為此電源裝置選擇一台 Klipper 印表機',
    moonrakerDeviceRequired: '請選擇一個電源裝置',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      notify: '透過 Notify 應用程式推送 iOS 通知，並在動態島顯示即時列印進度磁貼',
    },
    ...
    printAlmostDone: '即將完成',
    printAlmostDoneDescription: '在 97% 時傳送含攝影機快照的通知，以便列印一結束就取下零件',
    printerOffline: '印表機離線',
    printerError: '印表機錯誤',
  ...
  cameraTokens: {
    ...
    create: {
      ...
      hintTv:
        '電視權杖可在無需登入的螢幕上開啟 /tv——牆上的顯示器、看板模式下的樹莓派。它能看到每台印表機的狀態、正在列印的檔案、進度與已裝載的料盤，以及它們的攝影機快照。它看不到位址或存取碼。',
      title: '建立新權杖',
      nameLabel: '權杖名稱',
    ...
    created: {
      ...
      tvUrlTitle: '此螢幕的電視連結',
      tvUrlHint:
        '在螢幕上開啟此連結。加上 &cams=0 可隱藏攝影機畫面，加上 &refresh=10 可變更更新頻率。任何能讀到該連結的人都能看到這面牆，因此請把它當成鑰匙——撤銷權杖即可切斷顯示。',
      title: '權杖已建立 — 立即複製',
      warning:
